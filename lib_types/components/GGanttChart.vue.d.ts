...
declare const _default: __VLS_WithTemplateSlots<import("vue").DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<GGanttChartProps>, {
    currentTimeLabel: string;
    dateFormat: string;
    precision: string;
    width: string;
...
}, string, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<GGanttChartProps>, {
    currentTimeLabel: string;
    dateFormat: string;
    precision: string;
    width: string;
