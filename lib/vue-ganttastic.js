  ...
  (function(i, r) {
    ...
    return function(r, p, l) {
      ...
      s.isoWeekYear = function() {
        ...
        var a, f, g, x, k = u(this), m = (a = this.isoWeekYear(), f = this.$u, g = (f ? l.utc : l)().year(a).startOf("year"), x = 4 - g.isoWeekday(), g.isoWeekday() > 4 && (x += 7), g.add(x, i));
        return k.diff(m, "week") + 1;
    ...
    return function(m, v, w) {
      ...
      B.parse = function(b) {
        ...
        if (typeof _ == "string") {
          ...
          }(e, _, h), this.init(), S && S !== !0 && (this.$L = this.locale(S).$L), O && e != this.format(_) && (this.$d = new Date("")), s = {};
...
function Qt() {
  const { precision: t } = W(), { chartStartDayjs: c, chartEndDayjs: i } = ot(), r = H(() => {
    ...
    for (; x.isSameOrBefore(i.value); ) {
      const k = x.endOf(f), v = k.isAfter(i.value) ? i.value.diff(x, "minutes", !0) / n * 100 : k.diff(x, "minutes", !0) / n * 100;
      o.push({
    ...
    for (; g.isSameOrBefore(i.value); ) {
      const k = g.endOf(a), v = k.isAfter(i.value) ? i.value.diff(g, "minutes", !0) / n * 100 : k.diff(g, "minutes", !0) / n * 100;
      s.push({
        label: g.format(l[a]),
        value: String(g),
        date: g.toDate(),
...
const we = { class: "g-label-column-rows" }, be = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { font: c, colors: i, labelColumnTitle: r, rowHeight: p } = W(), l = kt();
    return (u, s) => (E(), T("div", {
...
const De = "cadetblue", Ee = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    const f = H(() => {
      ...
      if (!(r != null && r.value))
        return "";
      const v = i[p.value], w = g(x.value).format(v), B = g(k.value).format(v);
      return `${w} \u2013 ${B}`;
    });
...
function Lt(t, c = () => null, i = () => null, r = W()) {
  ...
  const { mapPositionToTime: a } = gt(r), { toDayjs: f } = ot(r), g = (y) => {
    ...
    if (!b || !e)
      return;
    const h = b.getBoundingClientRect().width, d = y.clientX - e.left - o, _ = d + h;
    w(d, _) || (t[p.value] = a(d), t[l.value] = a(_), c(y, t));
  }, m = (y) => {
    const { barElement: b, barContainer: e } = x();
    if (!b || !e)
      return;
...
function Je() {
  const t = W(), c = kt(), i = Xt(), { pushOnOverlap: r, barStart: p, barEnd: l, noOverlap: u, dateFormat: s } = t, o = /* @__PURE__ */ new Map(), { toDayjs: n, format: a } = ot(), f = (e, h) => {
    ...
    if (!(r != null && r.value))
      return;
    let h = e, { overlapBar: d, overlapType: _ } = m(h);
    for (; d; ) {
      y(d);
      ...
      d && (_ === "left" || _ === "right") && v(d, G, _), h = d, { overlapBar: d, overlapType: _ } = m(d);
    }
  }, m = (e) => {
    var A, P;
    let h, d, _;
    ...
    y(e), e.ganttBarConfig.bundle && c().forEach((_) => {
      _.bars.forEach((C) => {
    ...
    let e = !1;
    o.forEach((h, d) => {
      const { overlapBar: _ } = m(d);
      _ != null && (e = !0);
    }), e && o.forEach(({ oldStart: h, oldEnd: d }, _) => {
      _[p.value] = h, _[l.value] = d;
    });
  };
  return {
    initDragOfBar: f,
...
function tn() {
  const { pushOnOverlap: t } = W(), c = kt(), i = (u) => {
    ...
    return s === "left" ? a = n.filter((x) => {
      ...
      const m = document.getElementById(x.ganttBarConfig.id), v = document.getElementById(k.ganttBarConfig.id), w = Math.abs(m.offsetLeft - o.offsetLeft), B = Math.abs(v.offsetLeft - o.offsetLeft);
      return w < B ? x : k;
    }, a[0]) : null;
  };
  return {
...
const en = ["id"], nn = { class: "g-gantt-bar-label" }, rn = ["innerHTML"], an = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-left" }, null, -1), on = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-right" }, null, -1), sn = 8, ln = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    const n = L(!1), a = H(() => l.value.ganttBarConfig), f = dt(Nt), g = (d) => {
      ...
      i(d, l.value, C);
    }, { barStart: x, barEnd: k, width: m, chartStart: v, chartEnd: w, chartSize: B } = r, y = L(0), b = L(0), e = H(() => {
      const d = new Date(l.value.myBeginDate).getTime(), _ = new Date(l.value.myEndDate).getTime();
      return Math.abs(d - _) / (1e3 * 60 * 60 * 24) <= 2 ? 0 : b.value - y.value - sn;
    });
    return _t(() => {
      ft(
        [l, m, v, w, B.width],
        () => {
          y.value = s(l.value[x.value]), b.value = s(l.value[k.value]);
        },
        { deep: !0, immediate: !0 }
      );
    }), (d, _) => {
...
const un = /* @__PURE__ */ V({
  ...
  setup(t, { emit: c }) {
    ...
    const m = () => {
      const w = [], B = (y) => {
        const b = k(y);
        w.push(b), b.length && B(b);
      };
      return B(i.bars), console.log(w, " barsList"), w;
    };
    _t(() => {
