...
const Aa = /* @__PURE__ */ wt(Sa, [["__scopeId", "data-v-c3aa7bff"]]), Ma = { class: "g-gantt-legend" }, Pa = { class: "g-gantt-legend-collapse-container" }, $a = { class: "g-gantt-legend-areas-list" }, Ba = { class: "g-gantt-legend-title" }, La = { class: "g-gantt-legend-area" }, Ra = { class: "g-gantt-legend-category-name" }, Ia = 6, ja = /* @__PURE__ */ ee({
...
const Ha = /* @__PURE__ */ wt(ja, [["__scopeId", "data-v-c907221b"]]), Ya = /* @__PURE__ */ ee({
  __name: "GGanttLegend",
  props: {
    legend: {}
  },
...
`, "top");
xe(`
.g-gantt-legend-collapse-container[data-v-c3aa7bff] {
  display: flex;
  align-items: center;
  align-self: flex-end;
...
.g-gantt-legend-collapse[data-v-c3aa7bff] {
  display: flex;
  align-items: center;
  align-self: baseline;
  justify-content: flex-end;
...
.g-gantt-legend-collapse[data-v-c3aa7bff]:hover {
  cursor: pointer;
}
.g-gantt-legend-area-icon[data-v-c3aa7bff] {
  margin: 0 8px 0 24px;
}
.g-gantt-legend-area-icon > path[data-v-c3aa7bff] {
  fill: #4c5356;
}
.g-gantt-legend-promotion[data-v-c3aa7bff] {
  display: flex;
  flex-direction: column;
  gap: 4px;
}
.g-gantt-legend-areas-list[data-v-c3aa7bff] {
  display: flex;
  flex-direction: column;
}
.g-gantt-legend-area-list[data-v-c3aa7bff] {
  display: flex;
  flex-direction: column;
  gap: 6px;
}
.g-gantt-legend-do-collapse[data-v-c3aa7bff] {
  color: #008075;
}
.g-gantt-legend-category-color[data-v-c3aa7bff] {
  width: 60px;
  height: 6px;
...
.g-gantt-legend[data-v-c3aa7bff] {
  display: flex;
  flex-direction: column;
...
`, "top");
xe(`
.g-gantt-legend-collapse-container[data-v-c907221b] {
  display: flex;
  align-items: center;
  justify-content: flex-end;
...
.g-gantt-legend-collapse[data-v-c907221b] {
  display: flex;
  align-items: center;
  align-self: baseline;
  justify-content: flex-end;
...
.g-gantt-legend-collapse[data-v-c907221b]:hover {
  cursor: pointer;
}
.g-gantt-legend-title[data-v-c907221b] {
  display: flex;
  align-items: center;
  gap: 12px;
...
.g-gantt-legend-area[data-v-c907221b] {
  font-size: 16px;
  font-weight: 700;
  line-height: 24.8px;
}
.g-gantt-legend-area-icon > path[data-v-c907221b] {
  fill: #4c5356;
}
.g-gantt-legend-category-color[data-v-c907221b] {
  width: 60px;
  height: 6px;
...
.g-gantt-legend-promotion[data-v-c907221b] {
  display: flex;
  align-items: center;
  gap: 8px;
}
.g-gantt-legend-do-uncollapse[data-v-c907221b] {
  color: #008075;
}
.g-gantt-legend-area-list[data-v-c907221b] {
  display: flex;
  flex-direction: column;
  gap: 6px;
}
.g-gantt-legend-category-name[data-v-c907221b] {
  font-size: 14px;
  font-weight: 400;
  line-height: 18.2px;
...
.g-gantt-legend[data-v-c907221b] {
  display: flex;
  flex-direction: column;
