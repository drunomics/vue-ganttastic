import R from "dayjs";
import { inject as dt, computed as H, defineComponent as V, openBlock as E, createElementBlock as T, Fragment as K, renderList as et, unref as D, normalizeStyle as Y, renderSlot as I, createElementVNode as $, toDisplayString as Q, createCommentVNode as U, createTextVNode as rt, toRefs as at, ref as L, watch as ft, nextTick as Yt, createBlock as tt, Teleport as ne, createVNode as ct, Transition as re, withCtx as q, getCurrentScope as ae, onScopeDispose as oe, getCurrentInstance as ie, onMounted as kt, useSlots as se, provide as ut, normalizeClass as nt, useCssVars as le, withModifiers as ue, mergeProps as ce, TransitionGroup as de } from "vue";
  ...
  (function(i, r) {
    ...
    return function(r, p, l) {
      ...
      s.isoWeekYear = function() {
        ...
        var a, f, g, x, _ = u(this), m = (a = this.isoWeekYear(), f = this.$u, g = (f ? l.utc : l)().year(a).startOf("year"), x = 4 - g.isoWeekday(), g.isoWeekday() > 4 && (x += 7), g.add(x, i));
        return _.diff(m, "week") + 1;
...
(function(t, c) {
  (function(i, r) {
    ...
    return function(i, r) {
      r.prototype.isSameOrBefore = function(p, l) {
...
(function(t, c) {
  (function(i, r) {
    ...
    return function(i, r) {
      r.prototype.isSameOrAfter = function(p, l) {
...
(function(t, c) {
  (function(i, r) {
    ...
    var i = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, r = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, p = /\d\d/, l = /\d\d?/, u = /\d*[^-_:/,()\s\d]+/, s = {}, o = function(m) {
      return (m = +m) + (m > 68 ? 1900 : 2e3);
    }, n = function(m) {
      return function(v) {
        this[m] = +v;
      };
    }, a = [/[+-]\d\d:?(\d\d)?|Z/, function(m) {
      (this.zone || (this.zone = {})).offset = function(v) {
        if (!v || v === "Z")
          return 0;
        var w = v.match(/([+-]|\d\d)/g), B = 60 * w[1] + (+w[2] || 0);
      ...
      this.milliseconds = +m;
    }], s: [l, n("seconds")], ss: [l, n("seconds")], m: [l, n("minutes")], mm: [l, n("minutes")], H: [l, n("hours")], h: [l, n("hours")], HH: [l, n("hours")], hh: [l, n("hours")], D: [l, n("day")], DD: [p, n("day")], Do: [u, function(m) {
      var v = s.ordinal, w = m.match(/\d+/);
      if (this.day = w[0], v)
        for (var B = 1; B <= 31; B += 1)
          v(B).replace(/\[|\]/g, "") === m && (this.day = B);
    }], M: [l, n("month")], MM: [p, n("month")], MMM: [u, function(m) {
      var v = f("months"), w = (f("monthsShort") || v.map(function(B) {
        return B.slice(0, 3);
      })).indexOf(m) + 1;
      if (w < 1)
        throw new Error();
      ...
      if (v < 1)
        throw new Error();
      this.month = v % 12 || v;
    }], Y: [/[+-]?\d+/, n("year")], YY: [p, function(m) {
      this.year = o(m);
    }], YYYY: [/\d{4}/, n("year")], Z: a, ZZ: a };
    function _(m) {
      var v, w;
      v = m, w = s && s.formats;
      for (var B = (m = v.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(C, M, O) {
        var S = O && O.toUpperCase();
        return M || w[O] || i[O] || w[S].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(G, A, P) {
          return A || P.slice(1);
        });
      })).match(r), y = B.length, b = 0; b < y; b += 1) {
        var e = B[b], h = x[e], d = h && h[0], k = h && h[1];
        B[b] = k ? { regex: d, parser: k } : e.replace(/^\[|\]$/g, "");
      }
      return function(C) {
        for (var M = {}, O = 0, S = 0; O < y; O += 1) {
          var G = B[O];
          if (typeof G == "string")
            S += G.length;
          else {
            var A = G.regex, P = G.parser, F = C.slice(S), N = A.exec(F)[0];
    ...
    return function(m, v, w) {
      w.p.customParseFormat = !0, m && m.parseTwoDigitYear && (o = m.parseTwoDigitYear);
      ...
      B.parse = function(b) {
        ...
        var k = d[1];
        if (typeof k == "string") {
          var C = d[2] === !0, M = d[3] === !0, O = C || M, S = d[2];
          M && (S = d[2]), s = this.$locale(), !C && S && (s = w.Ls[S]), this.$d = function(F, N, j) {
            try {
              if (["x", "X"].indexOf(N) > -1)
                return new Date((N === "X" ? 1e3 : 1) * F);
              var z = _(N)(F), J = z.year, st = z.month, Kt = z.day, Zt = z.hours, Jt = z.minutes, te = z.seconds, ee = z.milliseconds, Ct = z.zone, ht = new Date(), pt = Kt || (J || st ? 1 : ht.getDate()), mt = J || ht.getFullYear(), lt = 0;
              J && !st || (lt = st > 0 ? st - 1 : ht.getMonth());
              var vt = Zt || 0, yt = Jt || 0, wt = te || 0, bt = ee || 0;
              return Ct ? new Date(Date.UTC(mt, lt, pt, vt, yt, wt, bt + 60 * Ct.offset * 1e3)) : j ? new Date(Date.UTC(mt, lt, pt, vt, yt, wt, bt)) : new Date(mt, lt, pt, vt, yt, wt, bt);
            } catch {
              return new Date("");
            }
          }(e, k, h), this.init(), S && S !== !0 && (this.$L = this.locale(S).$L), O && e != this.format(k) && (this.$d = new Date("")), s = {};
        } else if (k instanceof Array)
          for (var G = k.length, A = 1; A <= G; A += 1) {
            d[1] = k[A - 1];
            var P = w.apply(this, d);
            if (P.isValid()) {
...
function ot(t = W()) {
  const { chartStart: c, chartEnd: i, barStart: r, barEnd: p, dateFormat: l } = t, u = H(() => o(c.value)), s = H(() => o(i.value)), o = (a, f) => {
    let g;
    if (f !== void 0 && typeof a != "string" && !(a instanceof Date) && (g = f === "start" ? a[r.value] : a[p.value]), typeof a == "string")
      g = a;
...
function Qt() {
  const { precision: t } = W(), { chartStartDayjs: c, chartEndDayjs: i } = ot(), r = H(() => {
    ...
    const s = [], o = [], n = i.value.diff(c.value, "minutes", !0), a = r.value, f = p.value;
    let g = c.value, x = c.value;
    for (; x.isSameOrBefore(i.value); ) {
      const _ = x.endOf(f), v = _.isAfter(i.value) ? i.value.diff(x, "minutes", !0) / n * 100 : _.diff(x, "minutes", !0) / n * 100;
      o.push({
        label: x.format(l[t == null ? void 0 : t.value]),
        value: String(x),
        date: x.toDate(),
        width: String(v) + "%"
      }), x = _.add(1, f === "isoWeek" ? "week" : f).startOf(f);
    }
    for (; g.isSameOrBefore(i.value); ) {
      const _ = g.endOf(a), v = _.isAfter(i.value) ? i.value.diff(g, "minutes", !0) / n * 100 : _.diff(g, "minutes", !0) / n * 100;
      s.push({
        label: g.format(l[a]),
        value: String(g),
        date: g.toDate(),
        width: String(v) + "%"
      }), g = _.add(1, a).startOf(a);
    }
...
const ye = { class: "g-grid-container" }, Dt = /* @__PURE__ */ V({
  __name: "GGanttGrid",
  props: {
    highlightedUnits: {}
  },
  setup(t) {
    ...
    }, p = (l, u) => u === i.value.lowerUnits.length - 1 ? "unset" : l && Number(l) % 13 === 0 ? "2px solid #a8adb3" : "2px solid #f0f1f2";
    return (l, u) => (E(), T("div", ye, [
...
const we = { class: "g-label-column-rows" }, be = /* @__PURE__ */ V({
  __name: "GGanttLabelColumn",
  setup(t) {
    const { font: c, colors: i, labelColumnTitle: r, rowHeight: p } = W(), l = _t();
    return (u, s) => (E(), T("div", {
...
const xe = { class: "g-timeaxis" }, Be = { class: "g-timeunits-container g-timeunits-low" }, ke = {
  key: 0,
  class: "g-timeunit-low-kw"
}, _e = { class: "g-timeunits-container g-timeunits-upper" }, Ce = /* @__PURE__ */ V({
  __name: "GGanttTimeaxis",
  setup(t) {
    const { precision: c, colors: i } = W(), { timeaxisUnits: r } = Qt();
    return (p, l) => (E(), T("div", xe, [
      $("div", Be, [
...
const De = "cadetblue", Ee = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    }, { bar: r } = at(c), { precision: p, font: l, barStart: u, barEnd: s, rowHeight: o } = W(), n = L("0px"), a = L("0px");
    ft(
      () => c.bar,
      async () => {
        var e;
        await Yt();
        const v = ((e = r == null ? void 0 : r.value) == null ? void 0 : e.ganttBarConfig.id) || "";
        if (!v)
          return;
        const w = document.getElementById(v), { top: B, left: y } = (w == null ? void 0 : w.getBoundingClientRect()) || {
          top: 0,
          left: 0
        }, b = Math.max(y, 10);
    ...
    const f = H(() => {
      var v, w;
      return ((w = (v = r == null ? void 0 : r.value) == null ? void 0 : v.ganttBarConfig.style) == null ? void 0 : w.background) || De;
    }), { toDayjs: g } = ot(), x = H(() => {
      var v;
      return (v = r.value) == null ? void 0 : v[u.value];
    }), _ = H(() => {
      var v;
      return (v = r.value) == null ? void 0 : v[s.value];
    }), m = H(() => {
      if (!(r != null && r.value))
        return "";
      const v = i[p.value], w = g(x.value).format(v), B = g(_.value).format(v);
      return `${w} \u2013 ${B}`;
    });
    return (v, w) => (E(), tt(ne, { to: "body" }, [
      ct(re, {
        name: "g-fade",
        mode: "out-in"
      }, {
        default: q(() => [
          v.modelValue ? (E(), T("div", {
            key: 0,
...
function gt(t = W()) {
  const { dateFormat: c, chartSize: i } = t, { chartStartDayjs: r, chartEndDayjs: p, toDayjs: l, format: u } = ot(t), s = H(() => p.value.diff(r.value, "minutes"));
  return {
    mapTimeToPosition: (a) => {
...
const Oe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { mapTimeToPosition: c } = gt(), i = L(R()), { colors: r, dateFormat: p, currentTimeLabel: l } = W(), u = H(() => {
      const s = p.value || "YYYY-MM-DD HH:mm";
...
const Le = it ? window : void 0;
it && window.document;
it && window.navigator;
it && window.location;
function Ye(t, c = !1) {
  const i = L(), r = () => i.value = Boolean(t());
  return r(), Se(r, c), i;
}
...
function He(t, c, i = {}) {
  const r = i, { window: p = Le } = r, l = Re(r, ["window"]);
  let u;
  const s = Ye(() => p && "ResizeObserver" in p), o = () => {
    u && (u.disconnect(), u = void 0);
  }, n = ft(() => Vt(t), (f) => {
    o(), s.value && p && f && (u = new ResizeObserver(c), u.observe(f, l));
...
function Ae(t, c = { width: 0, height: 0 }, i = {}) {
  const r = L(c.width), p = L(c.height);
  return He(t, ([l]) => {
    r.value = l.contentRect.width, p.value = l.contentRect.height;
  }, i), ft(() => Vt(t), (l) => {
    r.value = l ? c.width : 0, p.value = l ? c.height : 0;
  }), {
    width: r,
    height: p
  };
...
const St = {
  ...
  setup(t, { emit: c }) {
    const i = t;
    R.extend(At);
    const r = new Date(), p = new Date();
    r.setDate(15), r.setMonth(10), p.setDate(31), p.setMonth(11);
    const l = L(
      R(new Date()).isBetween(r, p)
    ), { width: u, font: s, colorScheme: o } = at(i), n = se(), a = H(
      () => typeof o.value != "string" ? o.value : St[o.value] || St.default
    ), f = () => {
      var d;
      const e = (d = n.default) == null ? void 0 : d.call(n), h = [];
      return e && e.forEach((k) => {
        var C;
        if ((C = k.props) != null && C.bars) {
          const { label: M, bars: O } = k.props;
          h.push({ label: M, bars: O });
        } else
          Array.isArray(k.children) && k.children.forEach((M) => {
            var S;
            const O = M;
            if ((S = O == null ? void 0 : O.props) != null && S.bars) {
              const { label: G, bars: A } = O.props;
              h.push({ label: G, bars: A });
            }
          });
      }), h;
    }, g = L(!1), x = L(!1), _ = L(void 0);
    let m;
    const v = (e) => {
      ...
      switch (e.type) {
        ...
        case "dblclick":
          ...
          break;
        case "mouseenter":
          v(h), c("mouseenter-bar", { bar: h, e });
          break;
        case "mouseleave":
          w(), c("mouseleave-bar", { bar: h, e });
          break;
        case "dragstart":
        ...
        case "drag":
          ...
          break;
        case "dragend":
          x.value = !1, c("dragend-bar", { bar: h, e, movedBars: k });
          break;
        case "contextmenu":
    ...
    return document.getElementsByClassName("g-timeunit-low"), ut(zt, f), ut(Pt, {
      ...
      $("div", {
        ...
        $("div", {
          ...
          e.hideTimeaxis ? U("", !0) : (E(), tt(Ce, { key: 2 }, {
            "upper-timeunit": q(({ label: d, value: k, date: C }) => [
            ...
            timeunit: q(({ label: d, value: k, date: C }) => [
              I(e.$slots, "timeunit", {
                label: d,
                value: k,
                date: C
      ...
      ct(Ee, {
        ...
        default: q(() => [
          I(e.$slots, "bar-tooltip", { bar: _.value })
        ]),
        _: 3
      }, 8, ["model-value", "bar"])
    ], 2));
...
function Lt(t, c = () => null, i = () => null, r = W()) {
  const { barStart: p, barEnd: l, pushOnOverlap: u } = r, s = L(!1);
  let o = 0, n;
  const { mapPositionToTime: a } = gt(r), { toDayjs: f } = ot(r), g = (y) => {
    const b = document.getElementById(t.ganttBarConfig.id);
    if (!b)
      return;
    switch (o = y.clientX - (b.getBoundingClientRect().left || 0), y.target.className) {
      case "g-gantt-bar-handle-left":
        document.body.style.cursor = "ew-resize", n = m;
        break;
      case "g-gantt-bar-handle-right":
        document.body.style.cursor = "ew-resize", n = v;
        break;
      default:
        n = _;
    }
    ...
    var e;
    const y = document.getElementById(t.ganttBarConfig.id), b = (e = y == null ? void 0 : y.closest(".g-gantt-row-bars-container")) == null ? void 0 : e.getBoundingClientRect();
    return { barElement: y, barContainer: b };
  }, _ = (y) => {
    const { barElement: b, barContainer: e } = x();
    if (!b || !e)
      return;
    const h = b.getBoundingClientRect().width, d = y.clientX - e.left - o, k = d + h;
    w(d, k) || (t[p.value] = a(d), t[l.value] = a(k), c(y, t));
  }, m = (y) => {
    const { barElement: b, barContainer: e } = x();
    if (!b || !e)
      return;
    const h = y.clientX - e.left, d = a(h);
    f(d).isSameOrAfter(f(t, "end")) || (t[p.value] = d, c(y, t));
  }, v = (y) => {
    const { barElement: b, barContainer: e } = x();
    if (!b || !e)
      return;
    const h = y.clientX - e.left, d = a(h);
    f(d).isSameOrBefore(f(t, "start")) || (t[l.value] = d, c(y, t));
  }, w = (y, b) => {
    if (!u.value)
      return !1;
    const e = t.ganttBarConfig.dragLimitLeft, h = t.ganttBarConfig.dragLimitRight;
    return y && e != null && y < e || b && h != null && b > h;
  }, B = (y) => {
    s.value = !1, document.body.style.cursor = "", window.removeEventListener("mousemove", n), window.removeEventListener("mouseup", B), i(y, t);
  };
  return {
    isDragging: s,
    initDrag: g
...
function Je() {
  const t = W(), c = _t(), i = Xt(), { pushOnOverlap: r, barStart: p, barEnd: l, noOverlap: u, dateFormat: s } = t, o = /* @__PURE__ */ new Map(), { toDayjs: n, format: a } = ot(), f = (e, h) => {
    const { initDrag: d } = Lt(e, x, B, t);
    i({ ...h, type: "dragstart" }, e), d(h), y(e);
  }, g = (e, h) => {
    const d = e.ganttBarConfig.bundle;
    d != null && (c().forEach((k) => {
      k.bars.forEach((C) => {
        if (C.ganttBarConfig.bundle === d) {
          const M = C === e ? B : () => null, { initDrag: O } = Lt(C, x, M, t);
          O(h), y(C);
        }
      });
    ...
    if (!(r != null && r.value))
      return;
    let h = e, { overlapBar: d, overlapType: k } = m(h);
    for (; d; ) {
      y(d);
      const C = n(h[p.value]), M = n(h[l.value]), O = n(d[p.value]), S = n(d[l.value]);
      let G;
      switch (k) {
        case "left":
          G = S.diff(C, "minutes", !0), d[l.value] = a(h[p.value], s.value), d[p.value] = a(
            O.subtract(G, "minutes"),
            s.value
          );
          break;
        case "right":
          G = M.diff(O, "minutes", !0), d[p.value] = a(M, s.value), d[l.value] = a(
            S.add(G, "minutes"),
            s.value
          );
          break;
      ...
      d && (k === "left" || k === "right") && v(d, G, k), h = d, { overlapBar: d, overlapType: k } = m(d);
    }
  }, m = (e) => {
    var A, P;
    let h, d, k;
    const C = (P = (A = c().find((F) => F.bars.includes(e))) == null ? void 0 : A.bars) != null ? P : [], M = n(e[p.value]), O = n(e[l.value]);
    return { overlapBar: C.find((F) => {
      if (F === e)
        return !1;
      const N = n(F[p.value]), j = n(F[l.value]);
      return h = M.isBetween(N, j), d = O.isBetween(N, j), k = N.isBetween(M, O) || j.isBetween(M, O), h || d || k;
    }), overlapType: h ? "left" : d ? "right" : k ? "between" : null };
  }, v = (e, h, d) => {
    y(e), e.ganttBarConfig.bundle && c().forEach((k) => {
      k.bars.forEach((C) => {
        C.ganttBarConfig.bundle === e.ganttBarConfig.bundle && C !== e && (y(C), w(C, h, d));
      });
    });
  }, w = (e, h, d) => {
    switch (d) {
    ...
    let e = !1;
    o.forEach((h, d) => {
      const { overlapBar: k } = m(d);
      k != null && (e = !0);
    }), e && o.forEach(({ oldStart: h, oldEnd: d }, k) => {
      k[p.value] = h, k[l.value] = d;
    });
  };
  return {
    initDragOfBar: f,
...
function tn() {
  const { pushOnOverlap: t } = W(), c = _t(), i = (u) => {
    const s = [];
    ...
    for (const o of ["left", "right"]) {
      const n = o, { gapDistanceSoFar: a, bundleBarsAndGapDist: f } = p(
        u,
        0,
        n
      );
      ...
      for (let m = 0; m < x.length; m++) {
        const v = x[m].bar, w = x[m].gapDistance;
        i(v.ganttBarConfig.bundle).filter(
          (y) => y !== v
        ).forEach((y) => {
          const b = p(y, w, n), e = b.gapDistanceSoFar, h = b.bundleBarsAndGapDist;
          e != null && (!g || e < g) && (g = e), h.forEach((d) => {
            x.find((k) => k.bar === d.bar) || x.push(d);
          });
        });
      }
      const _ = document.getElementById(u.ganttBarConfig.id);
      g != null && n === "left" ? u.ganttBarConfig.dragLimitLeft = _.offsetLeft - g : g != null && n === "right" && (u.ganttBarConfig.dragLimitRight = _.offsetLeft + _.offsetWidth + g);
    }
    ...
    if (o === "left")
      for (; f; ) {
        const g = document.getElementById(a.ganttBarConfig.id), x = document.getElementById(f.ganttBarConfig.id), _ = x.offsetLeft + x.offsetWidth;
        if (s += g.offsetLeft - _, f.ganttBarConfig.immobile)
    ...
    if (o === "right")
      for (; f; ) {
        const g = document.getElementById(a.ganttBarConfig.id), x = document.getElementById(f.ganttBarConfig.id), _ = g.offsetLeft + g.offsetWidth;
        if (s += x.offsetLeft - _, f.ganttBarConfig.immobile)
          return { gapDistanceSoFar: s, bundleBarsAndGapDist: n };
        f.ganttBarConfig.bundle && n.push({
          bar: f,
          gapDistance: s
    ...
    return s === "left" ? a = n.filter((x) => {
      const _ = document.getElementById(x.ganttBarConfig.id);
      return _ && _.offsetLeft < o.offsetLeft && x.ganttBarConfig.pushOnOverlap !== !1;
    }) : a = n.filter((x) => {
      const _ = document.getElementById(x.ganttBarConfig.id);
      return _ && _.offsetLeft > o.offsetLeft && x.ganttBarConfig.pushOnOverlap !== !1;
    }), a.length > 0 ? a.reduce((x, _) => {
      const m = document.getElementById(x.ganttBarConfig.id), v = document.getElementById(_.ganttBarConfig.id), w = Math.abs(m.offsetLeft - o.offsetLeft), B = Math.abs(v.offsetLeft - o.offsetLeft);
      return w < B ? x : _;
    }, a[0]) : null;
  };
  return {
...
const en = ["id"], nn = { class: "g-gantt-bar-label" }, rn = ["innerHTML"], an = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-left" }, null, -1), on = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-right" }, null, -1), sn = 8, ln = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    const i = Xt(), r = W(), { rowHeight: p } = r, { bar: l } = at(c), u = (h = c.bar.ganttBarConfig.style) == null ? void 0 : h.backgroundColor, { mapTimeToPosition: s, mapPositionToTime: o } = gt();
    Je(), tn();
    const n = L(!1), a = H(() => l.value.ganttBarConfig), f = dt(Nt), g = (d) => {
      var M;
      d.preventDefault();
      const k = (M = f == null ? void 0 : f.value) == null ? void 0 : M.getBoundingClientRect();
      if (!k)
        return;
      const C = o(d.clientX - k.left);
      i(d, l.value, C);
    }, { barStart: x, barEnd: _, width: m, chartStart: v, chartEnd: w, chartSize: B } = r, y = L(0), b = L(0), e = H(() => {
      const d = new Date(l.value.myBeginDate).getTime(), k = new Date(l.value.myEndDate).getTime();
      return Math.abs(d - k) / (1e3 * 60 * 60 * 24) <= 2 ? 0 : b.value - y.value - sn;
    });
    return kt(() => {
      ft(
        [l, m, v, w, B.width],
        () => {
          y.value = s(l.value[x.value]), b.value = s(l.value[_.value]);
        },
        { deep: !0, immediate: !0 }
      );
    }), (d, k) => {
...
const un = /* @__PURE__ */ V({
  ...
  emits: ["drop"],
  setup(t, { emit: c }) {
    const i = t, r = L([]), { rowHeight: p, colors: l, labelColumnTitle: u } = W(), { highlightOnHover: s } = at(i), o = L(!1), n = H(() => ({
      height: `${p.value}px`,
      background: (s == null ? void 0 : s.value) && o.value ? l.value.hoverHighlight : null
    })), { mapPositionToTime: a } = gt(), f = L(null);
    ut(Nt, f);
    const g = (w) => {
      var e;
      ...
      const y = w.clientX - B.left, b = a(y);
      c("drop", { e: w, datetime: b });
    };
    function x(w, B, y, b) {
      return w <= b && y <= B;
    }
    function _(w) {
      ...
      return w.forEach((y) => {
        w.forEach((b) => {
          y.myBeginDate === b.myBeginDate && y.myEndDate === b.myEndDate || x(y.myBeginDate, y.myEndDate, b.myBeginDate, b.myEndDate) && B.push(R(y.myEndDate).isAfter(b.myEndDate) ? y : b);
        });
      }), B;
    }
    const m = () => {
      ...
      return ((y) => {
        ...
        for (; b.length > 0; ) {
          const e = _(b);
          if (w.push(e), e.length === 0)
            break;
          b = e;
        }
      })(i.bars), console.log(w, " barsList"), console.log("TEST"), w;
    };
    kt(() => {
      r.value = m(), console.log(r.value, "  barstornder");
    });
    const v = (w) => !w || /^\s*$/.test(w);
    return (w, B) => (E(), T("div", null, [
      (E(!0), T(K, null, et(r.value, (y) => (E(), T("div", {
        class: "g-gantt-row",
        style: Y(n.value),
        ...
        $("div", ce({
          ...
          ct(de, {
            ...
            default: q(() => [
              (E(!0), T(K, null, et(y, (b) => (E(), tt(ln, {
                key: b.ganttBarConfig.id,
                bar: b
              }, {
                default: q(() => [
                  I(w.$slots, "bar-label", { bar: b })
                ]),
                _: 2
              }, 1032, ["bar"]))), 128))
            ]),
