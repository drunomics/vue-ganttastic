import Q from "dayjs";
import { unref as L, getCurrentScope as Lr, onScopeDispose as Rr, getCurrentInstance as Yn, onMounted as be, nextTick as yt, ref as G, watch as je, inject as jt, computed as q, defineComponent as J, onUnmounted as Un, defineAsyncComponent as fn, useAttrs as Ir, openBlock as A, createBlock as _e, mergeProps as Wn, createElementBlock as R, Fragment as Z, createElementVNode as B, normalizeStyle as U, createVNode as Pe, toDisplayString as te, renderList as we, renderSlot as K, createCommentVNode as ie, createTextVNode as pt, useCssVars as Jt, onBeforeMount as jr, toRefs as vt, useSlots as Hr, provide as $t, normalizeClass as Bt, withCtx as ze, shallowRef as Gr, isRef as Ie, isReactive as pn, reactive as Yr, h as Ne, isVNode as Ur, createApp as vn, useTemplateRef as Wr, withModifiers as zr, TransitionGroup as Fr } from "vue";
var Xe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, zn = { exports: {} };
(function(e, t) {
  (function(n, r) {
    e.exports = r();
  })(Xe, function() {
...
(function(e, t) {
  (function(n, r) {
    ...
    var n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, r = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, o = /\d\d/, i = /\d\d?/, a = /\d*[^-_:/,()\s\d]+/, l = {}, u = function(v) {
      ...
      var C = b("months"), p = (b("monthsShort") || C.map(function(f) {
        return f.slice(0, 3);
      })).indexOf(v) + 1;
      if (p < 1)
        throw new Error();
        ...
        if (typeof T == "string") {
          ...
          E && (M = h[2]), l = this.$locale(), !$ && M && (l = p.Ls[M]), this.$d = function(F, N, W) {
            try {
              ...
              var V = O(N)(F), X = V.year, se = V.month, le = V.day, Ee = V.hours, ge = V.minutes, oe = V.seconds, he = V.milliseconds, Ae = V.zone, ae = new Date(), Oe = le || (X || se ? 1 : ae.getDate()), ue = X || ae.getFullYear(), me = 0;
              X && !se || (me = se > 0 ? se - 1 : ae.getMonth());
              var $e = Ee || 0, Se = ge || 0, Be = oe || 0, Le = he || 0;
              return Ae ? new Date(Date.UTC(ue, me, Oe, $e, Se, Be, Le + 60 * Ae.offset * 1e3)) : W ? new Date(Date.UTC(ue, me, Oe, $e, Se, Be, Le)) : new Date(ue, me, Oe, $e, Se, Be, Le);
            } catch {
              return new Date("");
            }
...
}), vo = { class: "g-gantt-grid-current-date" }, go = /* @__PURE__ */ J({
...
function ar() {
  const { precision: e } = He(), { chartStartDayjs: t, chartEndDayjs: n } = en(), r = q(() => {
    ...
    for (; x.isSameOrBefore(n.value); ) {
      const O = x.endOf(b), C = O.isAfter(n.value) ? n.value.diff(x, "minutes", !0) / d * 100 : O.diff(x, "minutes", !0) / d * 100;
      u.push({
...
const mo = /* @__PURE__ */ J({
  ...
  setup(e) {
    ...
    return (o, i) => (A(), R(Z, null, [
      (A(!0), R(Z, null, we(o.areaHeights, (a) => (A(), R("div", {
        key: a,
        style: U({
          position: "absolute",
          top: a + "px",
      ...
      (A(!0), R(Z, null, we(L(t).lowerUnits, ({ label: a, width: l }, u) => (A(), R("div", {
        key: a,
        style: U({
          width: l,
          borderRight: n(a, u),
  ...
  setup(e) {
    ...
    return be(() => {
      ...
      Pe(ho, { "parent-width": L(n) }, null, 8, ["parent-width"]),
      Pe(mo, { "area-heights": r.value }, null, 8, ["area-heights"])
    ], 512));
  }
});
...
const wo = { class: "g-label-column-rows" }, xo = /* @__PURE__ */ J({
  ...
  setup(e) {
    ...
    return (a, l) => (A(), R("div", {
      ...
      B("div", wo, [
        (A(!0), R(Z, null, we(L(i)(), ({ label: u }, d) => (A(), R("div", {
          key: `${u}_${d}`,
          ...
          K(a.$slots, "label-column-row", { label: u }, () => [
            B("span", null, te(u), 1)
          ])
        ], 4))), 128))
      ])
...
const Oo = { class: "g-timeaxis" }, Co = { class: "g-timeunits-container g-timeunits-low" }, _o = {
  key: 0,
  class: "g-timeunit-low-kw"
}, To = { class: "g-timeunits-container g-timeunits-upper" }, ko = /* @__PURE__ */ J({
  __name: "GGanttTimeaxis",
  setup(e) {
    const { precision: t, colors: n } = He(), { timeaxisUnits: r } = ar();
    return (o, i) => (A(), R("div", Oo, [
      B("div", Co, [
        (A(!0), R(Z, null, we(L(r).lowerUnits, ({ label: a, value: l, date: u, width: d }, c) => (A(), R("div", {
          key: a,
      ...
      B("div", To, [
        (A(!0), R(Z, null, we(L(r).upperUnits, ({ label: a, value: l, date: u, width: d }) => (A(), R("div", {
          key: a,
...
const Eo = { class: "g-gantt-legend-collapse" }, Ao = { class: "g-gantt-legend-areas-list" }, So = { class: "g-gantt-legend-promotion" }, Mo = 6, Po = /* @__PURE__ */ J({
  ...
  setup(e) {
    ...
    return be(() => {
      ...
      B("div", Ao, [
        (A(!0), R(Z, null, we(Object.entries(n.legend), ([o, i], a) => (A(), R("div", {
          key: o,
          ...
          K(n.$slots, "non-collapsed-view-area-name", {
            jopa: {
...
const $o = /* @__PURE__ */ it(Po, [["__scopeId", "data-v-58447c9e"]]), Bo = { class: "g-gantt-legend-collapse" }, Lo = { class: "g-gantt-legend-areas-list" }, Ro = { class: "g-gantt-legend-title" }, Io = { class: "g-gantt-legend-area" }, jo = { class: "g-gantt-legend-category-name" }, Ho = 6, Go = /* @__PURE__ */ J({
...
const Yo = /* @__PURE__ */ it(Go, [["__scopeId", "data-v-88971dc7"]]), Uo = { class: "g-gantt-legend" }, Wo = /* @__PURE__ */ J({
  __name: "GGanttLegend",
  props: {
    legend: {}
  },
  setup(e) {
    ...
    return jr(() => {
      ...
      t.value ? (A(), _e(Yo, {
        ...
        "arrow-name": n.value,
        legend: i.legend
      }, null, 8, ["is-collapsed", "arrow-name", "legend"])) : (A(), _e($o, {
        key: 0,
        "is-collapsed": t.value,
...
}, qo = { class: "g-gantt-rows-list" }, Xo = /* @__PURE__ */ J({
  __name: "GGanttChart",
  props: {
    chartStart: {},
    chartEnd: {},
      ...
      B("div", {
        ...
        p.labelColumnTitle ? (A(), _e(xo, {
          ...
          "label-column-title": ze(() => [
            K(p.$slots, "label-column-title")
          ]),
          "label-column-row": ze(({ label: _ }) => [
            K(p.$slots, "label-column-row", { label: _ })
          ]),
          _: 3
        }, 8, ["style"])) : ie("", !0),
        B("div", {
          ...
          p.currentTime ? (A(), _e(Do, { key: 1 }, {
            "current-time-label": ze(() => [
              K(p.$slots, "current-time-label")
            ]),
            _: 3
          })) : ie("", !0),
          B("div", No, [
          ...
          B("div", {
            ...
            Pe(On, { "highlighted-units": p.highlightedUnits }, null, 8, ["highlighted-units"])
          ], 2),
          p.hideTimeaxis ? ie("", !0) : (A(), _e(ko, { key: 2 }, {
            "upper-timeunit": ze(({ label: _, value: s, date: m }) => [
              K(p.$slots, "upper-timeunit", {
                date: m,
                label: _,
                value: s
              })
            ]),
            timeunit: ze(({ label: _, value: s, date: m }) => [
              K(p.$slots, "timeunit", {
                date: m,
                label: _,
                value: s
...
/*!
  ...
  * @license MIT
  */
var ne = "top", fe = "bottom", pe = "right", re = "left", nn = "auto", wt = [ne, fe, pe, re], et = "start", gt = "end", Qo = "clippingParents", ir = "viewport", ct = "popper", Ko = "reference", Cn = /* @__PURE__ */ wt.reduce(function(e, t) {
...
function la(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !de(i) || !ke(i) || (Object.assign(i.style, r), Object.keys(o).forEach(function(a) {
      var l = o[a];
...
function ua(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !de(o) || !ke(o) || (Object.assign(o.style, l), Object.keys(i).forEach(function(u) {
        o.removeAttribute(u);
      }));
    });
  };
...
function Ht(e) {
  return ke(e) === "html" ? e : e.assignedSlot || e.parentNode || (lr(e) ? e.host : null) || Ge(e);
}
function _n(e) {
  return !de(e) || De(e).position === "fixed" ? null : e.offsetParent;
}
function da(e) {
  ...
  for (var o = Ht(e); de(o) && ["html", "body"].indexOf(ke(o)) < 0; ) {
    var i = De(o);
...
function xt(e) {
  for (var t = xe(e), n = _n(e); n && ca(n) && De(n).position === "static"; )
    n = _n(n);
  return n && (ke(n) === "html" || ke(n) === "body" && De(n).position === "static") ? t : n || da(e) || t;
}
function on(e) {
...
function va(e) {
  ...
  if (!(!i || !a)) {
    var b = pa(o.padding, n), w = rn(i), x = u === "y" ? ne : re, O = u === "y" ? fe : pe, v = n.rects.reference[c] + n.rects.reference[u] - a[u] - n.rects.popper[c], C = a[u] - n.rects.reference[u], p = xt(i), f = p ? u === "y" ? p.clientHeight || 0 : p.clientWidth || 0 : 0, _ = v / 2 - C / 2, s = b[x], m = f - w[c] - b[O], y = f / 2 - w[c] / 2 + _, h = dt(s, y, m), T = u;
...
function Tn(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, i = e.variation, a = e.offsets, l = e.position, u = e.gpuAcceleration, d = e.adaptive, c = e.roundOffsets, b = e.isFixed, w = c === !0 ? ya(a) : typeof c == "function" ? c(a) : a, x = w.x, O = x === void 0 ? 0 : x, v = w.y, C = v === void 0 ? 0 : v, p = a.hasOwnProperty("x"), f = a.hasOwnProperty("y"), _ = re, s = ne, m = window;
  if (d) {
    var y = xt(n), h = "clientHeight", T = "clientWidth";
    if (y === xe(n) && (y = Ge(n), De(y).position !== "static" && l === "absolute" && (h = "scrollHeight", T = "scrollWidth")), y = y, o === ne || (o === re || o === pe) && i === gt) {
      s = fe;
  ...
  if (u) {
    var M;
    return Object.assign({}, S, (M = {}, M[s] = f ? "0" : "", M[_] = p ? "0" : "", M.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + O + "px, " + C + "px)" : "translate3d(" + O + "px, " + C + "px, 0)", M));
  }
  return Object.assign({}, S, (t = {}, t[s] = f ? C + "px" : "", t[_] = p ? O + "px" : "", t.transform = "", t));
}
function ba(e) {
...
function vr(e) {
  return ["html", "body", "#document"].indexOf(ke(e)) >= 0 ? e.ownerDocument.body : de(e) && ln(e) ? e : vr(Ht(e));
}
function ft(e, t) {
  var n;
  t === void 0 && (t = []);
...
function Ea(e) {
  var t = ft(Ht(e)), n = ["absolute", "fixed"].indexOf(De(e).position) >= 0, r = n && de(e) ? xt(e) : e;
  return tt(r) ? t.filter(function(o) {
    return tt(o) && cr(o, r) && ke(o) !== "body" && (n ? De(o).position !== "static" : !0);
  }) : [];
}
function Aa(e, t, n) {
...
function ht(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.boundary, a = i === void 0 ? Qo : i, l = n.rootBoundary, u = l === void 0 ? ir : l, d = n.elementContext, c = d === void 0 ? ct : d, b = n.altBoundary, w = b === void 0 ? !1 : b, x = n.padding, O = x === void 0 ? 0 : x, v = fr(typeof O != "number" ? O : pr(O, wt)), C = c === ct ? Ko : ct, p = e.rects.popper, f = e.elements[w ? C : c], _ = Aa(tt(f) ? f : f.contextElement || Ge(e.elements.popper), a, u), s = rt(e.elements.reference), m = gr({
    reference: s,
    element: p,
    strategy: "absolute",
    placement: o
...
function Sa(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, a = n.padding, l = n.flipVariations, u = n.allowedAutoPlacements, d = u === void 0 ? sr : u, c = ot(r), b = c ? l ? Cn : Cn.filter(function(O) {
    return ot(O) === c;
...
function Pa(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !0 : a, u = n.fallbackPlacements, d = n.padding, c = n.boundary, b = n.rootBoundary, w = n.altBoundary, x = n.flipVariations, O = x === void 0 ? !0 : x, v = n.allowedAutoPlacements, C = t.options.placement, p = Te(C), f = p === C, _ = u || (f || !O ? [Lt(C)] : Ma(C)), s = [C].concat(_).reduce(function(ge, oe) {
...
function Ua(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !1 : a, u = n.boundary, d = n.rootBoundary, c = n.altBoundary, b = n.padding, w = n.tether, x = w === void 0 ? !0 : w, O = n.tetherOffset, v = O === void 0 ? 0 : O, C = ht(t, {
    boundary: u,
    rootBoundary: d,
    padding: b,
    altBoundary: c
  }), p = Te(t.placement), f = ot(t.placement), _ = !f, s = on(p), m = Ya(s), y = t.modifiersData.popperOffsets, h = t.rects.reference, T = t.rects.popper, $ = typeof v == "function" ? v(Object.assign({}, t.rects, {
    placement: t.placement
  })) : v, E = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
  ...
  if (!!y) {
    if (i) {
      var I, H = s === "y" ? ne : re, z = s === "y" ? fe : pe, F = s === "y" ? "height" : "width", N = y[s], W = N + C[H], V = N - C[z], X = x ? -T[F] / 2 : 0, se = f === et ? h[F] : T[F], le = f === et ? -T[F] : -h[F], Ee = t.elements.arrow, ge = x && Ee ? rn(Ee) : {
        width: 0,
        height: 0
      }, oe = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : dr(), he = oe[H], Ae = oe[z], ae = dt(0, h[F], ge[F]), Oe = _ ? h[F] / 2 - X - ae - he - E.mainAxis : se - ae - he - E.mainAxis, ue = _ ? -h[F] / 2 + X + ae + Ae + E.mainAxis : le + ae + Ae + E.mainAxis, me = t.elements.arrow && xt(t.elements.arrow), $e = me ? s === "y" ? me.clientTop || 0 : me.clientLeft || 0 : 0, Se = (I = S == null ? void 0 : S[s]) != null ? I : 0, Be = N + Oe - Se - $e, Le = N + ue - Se, Qe = dt(x ? Rt(W, Be) : W, N, x ? Ve(V, Le) : V);
      y[s] = Qe, M[s] = Qe - N;
    }
    if (l) {
      var st, Ot = s === "x" ? ne : re, Ct = s === "x" ? fe : pe, Me = y[m], Re = m === "y" ? "height" : "width", lt = Me + C[Ot], Ye = Me - C[Ct], ut = [ne, re].indexOf(p) !== -1, _t = (st = S == null ? void 0 : S[m]) != null ? st : 0, Tt = ut ? lt : Me - h[Re] - T[Re] - _t + E.altAxis, kt = ut ? Me + h[Re] + T[Re] - _t - E.altAxis : Ye, Dt = x && ut ? fa(Tt, Me, kt) : dt(x ? Tt : lt, Me, x ? kt : Ye);
      y[m] = Dt, M[m] = Dt - Me;
    }
    t.modifiersData[r] = M;
  }
...
function Va(e, t, n) {
  ...
  return (r || !r && !n) && ((ke(t) !== "body" || ln(i)) && (l = Fa(t)), de(t) ? (u = rt(t, !0), u.x += t.clientLeft, u.y += t.clientTop) : i && (u.x = sn(i))), {
  ...
  return function(l, u, d) {
    ...
    var c = {
      ...
      setOptions: function(p) {
        ...
        var _ = Xa(Ka([].concat(r, c.options.modifiers)));
        return c.orderedModifiers = _.filter(function(s) {
          return s.enabled;
        }), O(), x.update();
      },
      forceUpdate: function() {
        if (!w) {
          ...
          if (!!Mn(f, _)) {
            c.rects = {
              reference: Va(f, xt(_), c.options.strategy === "fixed"),
              popper: rn(_)
    ...
    function O() {
      c.orderedModifiers.forEach(function(C) {
        var p = C.name, f = C.options, _ = f === void 0 ? {} : f, s = C.effect;
...
function li(e, t) {
  ...
  return e.every(function(o) {
    ...
    if (!c)
      return !0;
    var b = d === "bottom" ? c.top.y : 0, w = d === "top" ? c.bottom.y : 0, x = d === "right" ? c.left.x : 0, O = d === "left" ? c.right.x : 0, v = i.top - r + b > u, C = r - i.bottom - w > u, p = i.left - n + x > u, f = n - i.right - O > u;
    return v || C || p || f;
  });
}
function Ft(e, t, n) {
...
function ui() {
  Ce.isTouch || (Ce.isTouch = !0, window.performance && document.addEventListener("mousemove", _r));
}
function _r() {
  var e = performance.now();
  e - Rn < 20 && (Ce.isTouch = !1, document.removeEventListener("mousemove", _r)), Rn = e;
}
function ci() {
...
var wi = 1, Mt = [], Nt = [];
function xi(e, t) {
  var n = In(e, Object.assign({}, ye, Tr(Bn(t)))), r, o, i, a = !1, l = !1, u = !1, d = !1, c, b, w, x = [], O = Pn(Be, n.interactiveDebounce), v, C = wi++, p = null, f = oi(n.plugins), _ = {
    isEnabled: !0,
    isVisible: !1,
    isDestroyed: !1,
    isMounted: !1,
  ...
  function H() {
    var g = I().parentNode;
    return g ? Cr(g) : document;
  }
  function z() {
    return It(y);
  }
  function F(g) {
    return s.state.isMounted && !s.state.isVisible || Ce.isTouch || c && c.type === "focus" ? 0 : Wt(s.props.delay, g ? 0 : 1, ye.delay);
  }
  function N(g) {
  ...
  function V() {
    ...
    if (!!g.content) {
      ...
      Y.forEach(function(j) {
        var ee = j.getAttribute(k);
        if (s.state.isVisible)
          j.setAttribute(k, ee ? ee + " " + P : P);
        else {
          var ce = ee && ee.replace(P, "").trim();
    ...
    if (!(Ce.isTouch && (u || g.type === "mousedown"))) {
      ...
      if (!(s.props.interactive && Ln(y, k))) {
        if (Fe(s.props.triggerTarget || e).some(function(P) {
          ...
          if (Ce.isTouch || s.state.isVisible && s.props.trigger.indexOf("click") >= 0)
            return;
        } else
  ...
  function Be(g) {
    ...
    if (!(g.type === "mousemove" && P)) {
      var Y = Re().concat(y).map(function(j) {
        var ee, ce = j._tippy, Ke = (ee = ce.popperInstance) == null ? void 0 : ee.state;
        return Ke ? {
  ...
  function Ot() {
    Ct();
    var g = s.props, k = g.popperOptions, P = g.placement, Y = g.offset, j = g.getReferenceClientRect, ee = g.moveTransition, ce = M() ? It(y).arrow : null, Ke = j ? {
      ...
      fn: function(Et) {
        ...
        if (M()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(At) {
            At === "placement" ? Ut.setAttribute("data-placement", Ze.placement) : Ze.attributes.popper["data-popper-" + At] ? Ut.setAttribute("data-" + At, "") : Ut.removeAttribute("data-" + At);
    ...
    }), Ue.push.apply(Ue, (k == null ? void 0 : k.modifiers) || []), s.popperInstance = ei(Ke, y, Object.assign({}, k, {
      placement: P,
      onFirstUpdate: w,
      modifiers: Ue
    }));
  ...
  function lt(g) {
    ...
    Ce.isTouch && Y === "hold" && j && (k = j), k ? r = setTimeout(function() {
      s.show();
    }, k) : s.show();
  }
  function Ye(g) {
  ...
  function Ar() {
    var g = s.state.isVisible, k = s.state.isDestroyed, P = !s.state.isEnabled, Y = Ce.isTouch && !s.props.touch, j = Wt(s.props.duration, 0, ye.duration);
    if (!(g || k || P || Y) && !I().hasAttribute("disabled") && (W("onShow", [s], !1), s.props.onShow(s) !== !1)) {
      if (s.state.isVisible = !0, M() && (y.style.visibility = "visible"), N(), oe(), s.state.isMounted || (y.style.transition = "none"), M()) {
        var ee = z(), ce = ee.box, Ke = ee.content;
        zt([ce, Ke], 0);
      }
      w = function() {
        var Ue;
        if (!(!s.state.isVisible || d)) {
          if (d = !0, y.offsetHeight, y.style.transition = s.props.moveTransition, M() && s.props.animation) {
            var Yt = z(), Et = Yt.box, Ze = Yt.content;
            zt([Et, Ze], j), mt([Et, Ze], "visible");
          }
  ...
  function Sr() {
    ...
    if (!(g || k || P) && (W("onHide", [s], !1), s.props.onHide(s) !== !1)) {
      if (s.state.isVisible = !1, s.state.isShown = !1, d = !1, a = !1, M() && (y.style.visibility = "hidden"), se(), he(), N(!0), M()) {
        var j = z(), ee = j.box, ce = j.content;
        s.props.animation && (zt([ee, ce], Y), mt([ee, ce], "hidden"));
      }
      V(), X(), s.props.animation ? M() && Ae(Y, s.unmount) : s.unmount();
    }
  }
  function Mr(g) {
  ...
  function Pr() {
    s.state.isVisible && s.hide(), s.state.isMounted && (Ct(), Re().forEach(function(g) {
      g._tippy.unmount();
...
var Ei = {
  ...
  defaultValue: !1,
  fn: function(t) {
    var n = t.reference, r = Cr(t.props.triggerTarget || n), o = !1, i = !1, a = !0, l = t.props;
    function u() {
    ...
    function w(v) {
      var C = v.target ? n.contains(v.target) : !0, p = t.props.followCursor, f = v.clientX, _ = v.clientY, s = n.getBoundingClientRect(), m = f - s.left, y = _ - s.top;
      (C || !t.props.interactive) && t.setProps({
        getReferenceClientRect: function() {
          var T = n.getBoundingClientRect(), $ = f, E = _;
...
function Mi(e, t, n, r) {
  ...
  switch (e) {
    ...
    case "right": {
      ...
      }), C = v[0].top, p = v[v.length - 1].bottom, f = x, _ = O, s = _ - f, m = p - C;
      return {
        top: C,
        bottom: p,
        left: f,
...
function $i(e, t) {
  ...
  return be(() => {
    ...
    n.value = Ci(o, t ? { allowHTML: !0, ...t } : { allowHTML: !0 });
  }), {
    singleton: n
  };
}
      ...
      return A(), R("div", {
        ...
        B("div", Hi, [
          B("div", Gi, [
            ...
            L(n) ? (A(), _e(Je, {
              key: 0,
              name: (p = (C = (v = L(n)) == null ? void 0 : v.ganttBarConfig) == null ? void 0 : C.tooltipInfo) == null ? void 0 : p.icon,
              size: "24"
            }, null, 8, ["name"])) : ie("", !0)
          ]),
          B("div", Ui, [
            ...
            B("span", Wi, te((s = (_ = (f = L(n)) == null ? void 0 : f.ganttBarConfig) == null ? void 0 : _.tooltipInfo) == null ? void 0 : s.categoryName), 1),
            B("div", {
...
const Xi = /* @__PURE__ */ it(qi, [["__scopeId", "data-v-c08197b9"]]), Qi = ["id"], Ki = { class: "g-gantt-bar-label" }, Zi = ["innerHTML"], Ji = `
  ...
  setup(e) {
    ...
    const t = e, n = ji(), { bar: r } = vt(t), o = ($ = t.bar.ganttBarConfig.style) == null ? void 0 : $.backgroundColor, { mapTimeToPosition: i, mapPositionToTime: a } = tn(), { font: l, barEnd: u, barStart: d, rowHeight: c, width: b, chartStart: w, chartEnd: x, chartSize: O } = He(), v = G(), { toDayjs: C } = en(), p = G(!1), f = q(() => r.value.ganttBarConfig), _ = jt(rr), s = (E) => {
      var H;
    ...
    be(() => {
      !(v != null && v.value) || Er(v.value, {
        content: Ne(Xi, { bar: r.value, config: { barStart: d, barEnd: u, font: l }, toDayjs: C }),
        arrow: Ji,
        interactiveBorder: 0,
        placement: "top",
        interactive: !0,
    ...
    const m = (E) => {
      var I, H;
      if (E.preventDefault(), E.type === "mousedown" || !(_ != null && _.value))
        return;
    ...
    return be(() => {
      ...
      return A(), R("div", {
        ...
        f.value.hasHandles ? (A(), R(Z, { key: 1 }, [
...
const ns = /* @__PURE__ */ J({
  ...
  setup(e, { emit: t }) {
    ...
    const x = (f) => {
      var y, h;
      const _ = (h = (y = w.value) == null ? void 0 : y[0]) == null ? void 0 : h.getBoundingClientRect();
      if (!_) {
        console.error("Vue-Ganttastic: failed to find bar container element for row.");
        return;
      }
      const s = f.clientX - _.left, m = b(s);
      ...
      for (let s = 0; s < f.length; s++)
        for (let m = s + 1; m < f.length; m++)
          O(
            ...
            f[m].myBeginDate,
            f[m].myEndDate
          ) && _.push(Q(f[s].myEndDate).isAfter(f[m].myEndDate) ? f[s] : f[m]);
      return _;
    }
    const C = () => {
      const f = [], _ = (s) => {
    ...
    return (f, _) => (A(), R("div", null, [
      (A(!0), R(Z, null, we(r.value, (s) => (A(), R("div", {
        key: s[0].ganttBarConfig.id,
        style: U(c.value),
        class: "g-gantt-row",
        onDragleave: _[0] || (_[0] = (m) => d.value = !1),
        onDrop: _[1] || (_[1] = (m) => x(m)),
        onMouseleave: _[2] || (_[2] = (m) => d.value = !1),
        onMouseover: _[3] || (_[3] = (m) => d.value = !0),
        onDragover: _[4] || (_[4] = zr((m) => d.value = !0, ["prevent"]))
      }, [
        ...
        B("div", Wn({
          ...
          Pe(Fr, {
            ...
            default: ze(() => [
              (A(!0), R(Z, null, we(s, (m) => (A(), _e(ts, {
                key: m.ganttBarConfig.id,
                bar: m
              }, {
                default: ze(() => [
                  K(f.$slots, "bar-label", { bar: m })
                ]),
                _: 2
              }, 1032, ["bar"]))), 128))
            ]),
...
`, "top");
ve(`
.g-gantt-legend-collapse[data-v-58447c9e] {
  display: flex;
  align-items: center;
  justify-content: flex-end;
...
.g-gantt-legend-area-icon[data-v-58447c9e] {
  margin: 0 8px 0 16px;
}
.g-gantt-legend-promotion[data-v-58447c9e] {
  display: flex;
  flex-direction: column;
  gap: 4px;
}
.g-gantt-legend-areas-list[data-v-58447c9e] {
  display: flex;
  flex-direction: column;
}
.g-gantt-legend-area-list[data-v-58447c9e] {
  display: flex;
  flex-direction: column;
  gap: 6px;
}
.g-gantt-legend-do-collapse[data-v-58447c9e]:hover {
  cursor: pointer;
  color: #008075;
}
.g-gantt-legend-category-color[data-v-58447c9e] {
  width: 44px;
  height: 6px;
