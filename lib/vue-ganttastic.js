...
(function(e, t) {
  (function(n, r) {
    ...
    function O(v) {
      var C, p;
      C = v, p = l && l.formats;
      for (var f = (v = C.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(B, S, A) {
        var M = A && A.toUpperCase();
        return S || p[A] || n[A] || p[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(I, H, z) {
          return H || z.slice(1);
        });
      ...
      return function(B) {
        for (var S = {}, A = 0, M = 0; A < _; A += 1) {
          var I = f[A];
          if (typeof I == "string")
            M += I.length;
          else {
            var H = I.regex, z = I.parser, N = B.slice(M), U = H.exec(N)[0];
            z.call(S, U), B = B.replace(U, "");
          }
        }
        return function(W) {
          var V = W.afternoon;
    ...
    return function(v, C, p) {
      ...
      f.parse = function(i) {
        ...
        var T = h[1];
        if (typeof T == "string") {
          var B = h[2] === !0, S = h[3] === !0, A = B || S, M = h[2];
          S && (M = h[2]), l = this.$locale(), !B && M && (l = p.Ls[M]), this.$d = function(N, U, W) {
            try {
              if (["x", "X"].indexOf(U) > -1)
                return new Date((U === "X" ? 1e3 : 1) * N);
              var V = O(U)(N), X = V.year, le = V.month, ue = V.day, Ee = V.hours, he = V.minutes, ae = V.seconds, me = V.milliseconds, Se = V.zone, ie = new Date(), Oe = ue || (X || le ? 1 : ie.getDate()), ce = X || ie.getFullYear(), ye = 0;
              X && !le || (ye = le > 0 ? le - 1 : ie.getMonth());
              var Pe = Ee || 0, Ae = he || 0, $e = ae || 0, Be = me || 0;
              return Se ? new Date(Date.UTC(ce, ye, Oe, Pe, Ae, $e, Be + 60 * Se.offset * 1e3)) : W ? new Date(Date.UTC(ce, ye, Oe, Pe, Ae, $e, Be)) : new Date(ce, ye, Oe, Pe, Ae, $e, Be);
            } catch {
              return new Date("");
            }
          }(y, T, b), this.init(), M && M !== !0 && (this.$L = this.locale(M).$L), A && y != this.format(T) && (this.$d = new Date("")), l = {};
...
const To = { class: "g-gantt-legend-collapse" }, ko = { class: "g-gantt-legend-areas-list" }, Do = { class: "g-gantt-legend-promotion" }, Eo = 6, So = /* @__PURE__ */ ee({
...
const Ao = /* @__PURE__ */ it(So, [["__scopeId", "data-v-1dd633de"]]), Mo = { class: "g-gantt-legend-collapse" }, Po = { class: "g-gantt-legend-areas-list" }, $o = { class: "g-gantt-legend-title" }, Bo = { class: "g-gantt-legend-area" }, Lo = { class: "g-gantt-legend-category-name" }, Ro = 6, Io = /* @__PURE__ */ ee({
  ...
  setup(e) {
    ...
    return $r(() => {
      ...
      t.value ? (E(), te(jo, {
        ...
        "arrow-name": n.value,
        legend: s.legend
      }, null, 8, ["is-collapsed", "arrow-name", "legend"])) : (E(), te(Ao, {
        key: 0,
        "is-collapsed": t.value,
        ...
        if ((y = i.props) != null && y.bars) {
          ...
          Array.isArray(i.children) && i.children.forEach((b) => {
            ...
            if ((T = h == null ? void 0 : h.props) != null && T.bars) {
              const { label: B, bars: S } = h.props;
              f.push({ label: B, bars: S });
            }
          });
      }), f;
    }, x = Y(!1), O = (p, f, _, i) => {
...
function Cn(e) {
  ...
  if (d) {
    ...
    if (o === oe || (o === re || o === pe) && s === ht) {
      _ = ve;
      var S = m && y.visualViewport ? y.visualViewport.width : b[T];
      O -= S - r.width, O *= u ? 1 : -1;
    }
  }
  var A = Object.assign({
  ...
  if (u) {
    var M;
    return Object.assign({}, A, (M = {}, M[i] = f ? "0" : "", M[_] = p ? "0" : "", M.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + O + "px, " + C + "px)" : "translate3d(" + O + "px, " + C + "px, 0)", M));
  }
  return Object.assign({}, A, (t = {}, t[i] = f ? C + "px" : "", t[_] = p ? O + "px" : "", t.transform = "", t));
}
function ha(e) {
...
function mt(e, t) {
  ...
  if (c === ct && B) {
    ...
    Object.keys(T).forEach(function(A) {
      var M = [ve, pe].indexOf(A) >= 0 ? 1 : -1, I = [re, pe].indexOf(A) >= 0 ? "y" : "x";
      T[A] += S[I] * M;
    });
  }
  return T;
...
function Sa(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, s = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !0 : a, u = n.fallbackPlacements, d = n.padding, c = n.boundary, m = n.rootBoundary, w = n.altBoundary, x = n.flipVariations, O = x === void 0 ? !0 : x, v = n.allowedAutoPlacements, C = t.options.placement, p = _e(C), f = p === C, _ = u || (f || !O ? [Rt(C)] : Ea(C)), i = [C].concat(_).reduce(function(he, ae) {
    ...
    }, []), y = t.rects.reference, b = t.rects.popper, h = /* @__PURE__ */ new Map(), T = !0, B = i[0], S = 0; S < i.length; S++) {
      var A = i[S], M = _e(A), I = ot(A) === et, H = [re, pe].indexOf(M) >= 0, z = H ? "width" : "height", N = mt(t, {
        placement: A,
        boundary: c,
        rootBoundary: m,
        altBoundary: w,
      ...
      y[z] > b[z] && (U = Rt(U));
      var W = Rt(U), V = [];
      if (s && V.push(N[M] <= 0), l && V.push(N[U] <= 0, N[W] <= 0), V.every(function(he) {
        return he;
      })) {
        B = A, T = !1;
        break;
...
function Ha(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, s = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !1 : a, u = n.boundary, d = n.rootBoundary, c = n.altBoundary, m = n.padding, w = n.tether, x = w === void 0 ? !0 : w, O = n.tetherOffset, v = O === void 0 ? 0 : O, C = mt(t, {
    ...
    mainAxis: 0,
    altAxis: 0
  }, B), A = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, M = {
    x: 0,
    y: 0
  };
  if (!!b) {
    if (s) {
      var I, H = i === "y" ? re : oe, z = i === "y" ? pe : ve, N = i === "y" ? "height" : "width", U = b[i], W = U + C[H], V = U - C[z], X = x ? -T[N] / 2 : 0, le = f === et ? h[N] : T[N], ue = f === et ? -T[N] : -h[N], Ee = t.elements.arrow, he = x && Ee ? rn(Ee) : {
        width: 0,
        height: 0
      }, ae = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : sr(), me = ae[H], Se = ae[z], ie = dt(0, h[N], he[N]), Oe = _ ? h[N] / 2 - X - ie - me - S.mainAxis : le - ie - me - S.mainAxis, ce = _ ? -h[N] / 2 + X + ie + Se + S.mainAxis : ue + ie + Se + S.mainAxis, ye = t.elements.arrow && Ot(t.elements.arrow), Pe = ye ? i === "y" ? ye.clientTop || 0 : ye.clientLeft || 0 : 0, Ae = (I = A == null ? void 0 : A[i]) != null ? I : 0, $e = U + Oe - Ae - Pe, Be = U + ce - Ae, Ke = dt(x ? It(W, $e) : W, U, x ? ze(V, Be) : V);
      b[i] = Ke, M[i] = Ke - U;
    }
    if (l) {
      var st, Ct = i === "x" ? re : oe, _t = i === "x" ? pe : ve, Me = b[y], Le = y === "y" ? "height" : "width", lt = Me + C[Ct], Ge = Me - C[_t], ut = [re, oe].indexOf(p) !== -1, Tt = (st = A == null ? void 0 : A[y]) != null ? st : 0, kt = ut ? lt : Me - h[Le] - T[Le] - Tt + S.altAxis, Dt = ut ? Me + h[Le] + T[Le] - Tt - S.altAxis : Ge, Et = x && ut ? ua(kt, Me, Dt) : dt(x ? kt : lt, Me, x ? Dt : Ge);
      b[y] = Et, M[y] = Et - Me;
    }
    t.modifiersData[r] = M;
  }
...
var Qa = [ba, Ia, ma, ar, La, Aa, Ga, pa, Pa], Ka = /* @__PURE__ */ Xa({
  defaultModifiers: Qa
...
var mi = 1, Pt = [], zt = [];
function yi(e, t) {
  var n = Ln(e, Object.assign({}, be, xr(Pn(t)))), r, o, s, a = !1, l = !1, u = !1, d = !1, c, m, w, x = [], O = An($e, n.interactiveDebounce), v, C = mi++, p = null, f = ti(n.plugins), _ = {
    isEnabled: !0,
    isVisible: !1,
    isDestroyed: !1,
    isMounted: !1,
  ...
  return ye(), X(), U(), W("onCreate", [i]), n.showOnCreate && lt(), b.addEventListener("mouseenter", function() {
  ...
  function Dt(g) {
    if (!i.state.isDestroyed) {
      ...
      i.props = P, ye(), k.interactiveDebounce !== P.interactiveDebounce && (le(), O = An($e, P.interactiveDebounce)), k.triggerTarget && !P.triggerTarget ? Fe(k.triggerTarget).forEach(function(G) {
        G.removeAttribute("aria-expanded");
      }) : P.triggerTarget && e.removeAttribute("aria-expanded"), X(), U(), h && h(k, P), i.popperInstance && (Ct(), Le().forEach(function(G) {
  ...
  function Tr() {
    ...
    if (!(g || k || P || G) && !I().hasAttribute("disabled") && (W("onShow", [i], !1), i.props.onShow(i) !== !1)) {
      if (i.state.isVisible = !0, M() && (b.style.visibility = "visible"), U(), ae(), i.state.isMounted || (b.style.transition = "none"), M()) {
        var Z = z(), de = Z.box, Ze = Z.content;
        Ft([de, Ze], 0);
      }
      w = function() {
        var Ye;
        if (!(!i.state.isVisible || d)) {
          if (d = !0, b.offsetHeight, b.style.transition = i.props.moveTransition, M() && i.props.animation) {
            var Yt = z(), St = Yt.box, Je = Yt.content;
            Ft([St, Je], j), yt([St, Je], "visible");
          }
  ...
  function kr() {
    ...
    if (!(g || k || P) && (W("onHide", [i], !1), i.props.onHide(i) !== !1)) {
      if (i.state.isVisible = !1, i.state.isShown = !1, d = !1, a = !1, M() && (b.style.visibility = "hidden"), le(), me(), U(!0), M()) {
        var j = z(), Z = j.box, de = j.content;
        i.props.animation && (Ft([Z, de], G), yt([Z, de], "hidden"));
      }
      V(), X(), i.props.animation ? M() && Se(G, i.unmount) : i.unmount();
    }
  }
  function Dr(g) {
    ...
    function w(v) {
      ...
      (C || !t.props.interactive) && t.setProps({
        getReferenceClientRect: function() {
          var T = n.getBoundingClientRect(), B = f, S = _;
          p === "initial" && (B = T.left + y, S = T.top + b);
          var A = p === "horizontal" ? T.top : S, M = p === "vertical" ? T.right : B, I = p === "horizontal" ? T.bottom : S, H = p === "vertical" ? T.left : B;
          return {
            width: M - H,
            height: I - A,
            top: A,
...
const zi = /* @__PURE__ */ it(Ni, [["__scopeId", "data-v-00b81e26"]]), Vi = ["id"], qi = { class: "g-gantt-bar-label" }, Xi = ["innerHTML"], Qi = `
  ...
  setup(e) {
    ...
    const t = e, n = Li(), { bar: r } = gt(t), o = (B = t.bar.ganttBarConfig.style) == null ? void 0 : B.backgroundColor, { mapTimeToPosition: s, mapPositionToTime: a } = tn(), { font: l, barEnd: u, barStart: d, rowHeight: c, width: m, chartStart: w, chartEnd: x, chartSize: O } = je(), v = Y(), { toDayjs: C } = en(), p = Y(!1), f = q(() => r.value.ganttBarConfig), _ = Ie(Jn), i = (S) => {
      var z, N;
      const A = document.querySelector(".tippy-svg-arrow");
      if (!A)
        return;
      const I = ((z = A.style.transform) != null ? z : "").match(/translate3d\((-?\d+)/), H = (N = document.querySelector(".tippy-content")) == null ? void 0 : N.clientHeight;
      if (S === "bottom" && I) {
        const U = A.firstElementChild;
        U.style.transform = "rotateX(180deg)";
        const W = parseInt(I[1]);
        A.style.transform = `translate3d(${W}px, -${H + 7}px, 0px)`;
      }
      if (S === "top" && I) {
        const U = parseInt(I[1]);
        A.style.transform = `translate3d(${U}px, -1px, 0px)`;
      }
    };
    Te(() => {
        ...
        popperOptions: {
          modifiers: [
            ...
            },
            {
              ...
              phase: "write",
              fn({ instance: S }) {
                i((S == null ? void 0 : S.state.placement) || "top");
              }
            }
          ]
        },
    ...
    const y = (S) => {
      var I, H;
      if (S.preventDefault(), S.type === "mousedown" || !(_ != null && _.value))
        return;
      const A = (H = (I = _ == null ? void 0 : _.value) == null ? void 0 : I[0]) == null ? void 0 : H.getBoundingClientRect();
      if (!A)
        return;
      const M = a(S.clientX - A.left);
      n(S, r.value, M);
    }, b = Y(0), h = Y(0), T = q(() => {
      const S = new Date(r.value.myBeginDate).getTime(), A = new Date(r.value.myEndDate).getTime();
      return Math.abs(S - A) / (1e3 * 60 * 60 * 24) <= 2 ? 0 : h.value - b.value - Ki;
    });
    return Te(() => {
      qe(
        [r, m, w, x, O.width],
      ...
      return E(), R("div", {
        ...
        f.value.hasHandles ? (E(), R(K, { key: 1 }, [
          A[0] || (A[0] = L("div", { class: "g-gantt-bar-handle-left" }, null, -1)),
          A[1] || (A[1] = L("div", { class: "g-gantt-bar-handle-right" }, null, -1))
        ], 64)) : se("", !0)
      ], 46, Vi);
    };
  }
  ...
  setup(e, { emit: t }) {
    ...
    return (f, _) => (E(), R("div", null, [
      (E(!0), R(K, null, we(r.value, (i) => (E(), R("div", {
        ...
        !p(f.label) && !$(l) ? (E(), R("div", {
          key: 0,
          style: F({ background: $(a).primary, color: $(a).text }),
