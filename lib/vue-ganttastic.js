  ...
  (function(i, r) {
    ...
    var i = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, r = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, p = /\d\d/, l = /\d\d?/, u = /\d*[^-_:/,()\s\d]+/, s = {}, o = function(m) {
      ...
      (this.zone || (this.zone = {})).offset = function(y) {
        if (!y || y === "Z")
          return 0;
        var w = y.match(/([+-]|\d\d)/g), b = 60 * w[1] + (+w[2] || 0);
      ...
      var y = s.ordinal, w = m.match(/\d+/);
      if (this.day = w[0], y)
        for (var b = 1; b <= 31; b += 1)
          y(b).replace(/\[|\]/g, "") === m && (this.day = b);
    }], M: [l, n("month")], MM: [p, n("month")], MMM: [u, function(m) {
      var y = f("months"), w = (f("monthsShort") || y.map(function(b) {
        return b.slice(0, 3);
      })).indexOf(m) + 1;
      if (w < 1)
        throw new Error();
  ...
  setup(t) {
    ...
    ft(
      ...
      async () => {
        ...
        if (!y)
          return;
        const w = document.getElementById(y), { top: b, left: v } = (w == null ? void 0 : w.getBoundingClientRect()) || {
          top: 0,
          left: 0
        }, B = Math.max(v, 10);
    ...
    const f = H(() => {
      var y, w;
      return ((w = (y = r == null ? void 0 : r.value) == null ? void 0 : y.ganttBarConfig.style) == null ? void 0 : w.background) || De;
    }), { toDayjs: g } = ot(), x = H(() => {
      var y;
      ...
      if (!(r != null && r.value))
        return "";
      const y = i[p.value], w = g(x.value).format(y), b = g(k.value).format(y);
      return `${w} \u2013 ${b}`;
    });
    return (y, w) => (E(), tt(ne, { to: "body" }, [
      ct(re, {
        name: "g-fade",
        mode: "out-in"
      }, {
...
function Lt(t, c = () => null, i = () => null, r = W()) {
  ...
  let o = 0, n;
  const { mapPositionToTime: a } = gt(r), { toDayjs: f } = ot(r), g = (v) => {
    const B = document.getElementById(t.ganttBarConfig.id);
    if (!B)
      return;
    switch (o = v.clientX - (B.getBoundingClientRect().left || 0), v.target.className) {
    ...
    var e;
    const v = document.getElementById(t.ganttBarConfig.id), B = (e = v == null ? void 0 : v.closest(".g-gantt-row-bars-container")) == null ? void 0 : e.getBoundingClientRect();
    return { barElement: v, barContainer: B };
  }, k = (v) => {
    const { barElement: B, barContainer: e } = x();
    if (!B || !e)
      return;
    const h = B.getBoundingClientRect().width, d = v.clientX - e.left - o, _ = d + h;
    w(d, _) || (t[p.value] = a(d), t[l.value] = a(_), c(v, t));
  }, m = (v) => {
    const { barElement: B, barContainer: e } = x();
    if (!B || !e)
      return;
    const h = v.clientX - e.left, d = a(h);
    f(d).isSameOrAfter(f(t, "end")) || (t[p.value] = d, c(v, t));
  }, y = (v) => {
    const { barElement: B, barContainer: e } = x();
    if (!B || !e)
      return;
    const h = v.clientX - e.left, d = a(h);
    f(d).isSameOrBefore(f(t, "start")) || (t[l.value] = d, c(v, t));
  }, w = (v, B) => {
    if (!u.value)
      return !1;
    const e = t.ganttBarConfig.dragLimitLeft, h = t.ganttBarConfig.dragLimitRight;
    return v && e != null && v < e || B && h != null && B > h;
  }, b = (v) => {
    s.value = !1, document.body.style.cursor = "", window.removeEventListener("mousemove", n), window.removeEventListener("mouseup", b), i(v, t);
  };
  return {
    isDragging: s,
    initDrag: g
...
function Je() {
  const t = W(), c = kt(), i = Xt(), { pushOnOverlap: r, barStart: p, barEnd: l, noOverlap: u, dateFormat: s } = t, o = /* @__PURE__ */ new Map(), { toDayjs: n, format: a } = ot(), f = (e, h) => {
    ...
    for (; d; ) {
      ...
      d && (_ === "left" || _ === "right") && y(d, G, _), h = d, { overlapBar: d, overlapType: _ } = m(d);
    }
  }, m = (e) => {
    var A, P;
    let h, d, _;
    ...
    v(e), e.ganttBarConfig.bundle && c().forEach((_) => {
      _.bars.forEach((C) => {
        C.ganttBarConfig.bundle === e.ganttBarConfig.bundle && C !== e && (v(C), w(C, h, d));
      });
    });
  }, w = (e, h, d) => {
    switch (d) {
  ...
  const { pushOnOverlap: t } = W(), c = kt(), i = (u) => {
    ...
    for (const o of ["left", "right"]) {
      ...
      for (let m = 0; m < x.length; m++) {
        const y = x[m].bar, w = x[m].gapDistance;
        i(y.ganttBarConfig.bundle).filter(
          (v) => v !== y
        ).forEach((v) => {
          const B = p(v, w, n), e = B.gapDistanceSoFar, h = B.bundleBarsAndGapDist;
    ...
    return s === "left" ? a = n.filter((x) => {
      ...
      const m = document.getElementById(x.ganttBarConfig.id), y = document.getElementById(k.ganttBarConfig.id), w = Math.abs(m.offsetLeft - o.offsetLeft), b = Math.abs(y.offsetLeft - o.offsetLeft);
      return w < b ? x : k;
    }, a[0]) : null;
  };
  return {
...
const en = ["id"], nn = { class: "g-gantt-bar-label" }, rn = ["innerHTML"], an = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-left" }, null, -1), on = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-right" }, null, -1), sn = 8, ln = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    const n = L(!1), a = H(() => l.value.ganttBarConfig), f = dt(Nt), g = (d) => {
      ...
      i(d, l.value, C);
    }, { barStart: x, barEnd: k, width: m, chartStart: y, chartEnd: w, chartSize: b } = r, v = L(0), B = L(0), e = H(() => {
      const d = new Date(l.value.myBeginDate).getTime(), _ = new Date(l.value.myEndDate).getTime();
      return Math.abs(d - _) / (1e3 * 60 * 60 * 24) <= 2 ? 0 : B.value - v.value - sn;
    });
    return _t(() => {
      ft(
        [l, m, y, w, b.width],
        () => {
          v.value = s(l.value[x.value]), B.value = s(l.value[k.value]);
        },
        { deep: !0, immediate: !0 }
      );
    }), (d, _) => {
...
const un = /* @__PURE__ */ V({
  ...
  setup(t, { emit: c }) {
    ...
    const g = (w) => {
      ...
      const v = w.clientX - b.left, B = a(v);
    ...
    function k(w) {
      ...
      return w.forEach((v) => {
        w.forEach((B) => {
          v.myBeginDate === B.myBeginDate && v.myEndDate === B.myEndDate || x(v.myBeginDate, v.myEndDate, B.myBeginDate, B.myEndDate) && b.push(R(v.myEndDate).isAfter(B.myEndDate) ? v : B);
        });
      }), b;
    }
    const m = () => {
      ...
      let b = [];
      const v = (B) => {
        b = k(B), w.push(b), b.length > 0 && v(b);
      };
      return v(i.bars), console.log("TESTS"), console.log(w, " barsList"), w;
    };
    _t(() => {
      r.value = m(), console.log(r.value, "  barstornder");
    });
    const y = (w) => !w || /^\s*$/.test(w);
    return (w, b) => (E(), T("div", null, [
      (E(!0), T(K, null, et(r.value, (v) => (E(), T("div", {
        class: "g-gantt-row",
        style: Y(n.value),
