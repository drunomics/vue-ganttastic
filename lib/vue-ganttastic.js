  ...
  (function(i, r) {
    ...
    return function(r, v, l) {
      ...
      s.isoWeekYear = function() {
        ...
        var a, f, g, x, k = u(this), y = (a = this.isoWeekYear(), f = this.$u, g = (f ? l.utc : l)().year(a).startOf("year"), x = 4 - g.isoWeekday(), g.isoWeekday() > 4 && (x += 7), g.add(x, i));
        return k.diff(y, "week") + 1;
...
(function(t, c) {
  (function(i, r) {
    ...
    var i = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, r = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, v = /\d\d/, l = /\d\d?/, u = /\d*[^-_:/,()\s\d]+/, s = {}, o = function(y) {
      return (y = +y) + (y > 68 ? 1900 : 2e3);
    }, n = function(y) {
      return function(w) {
        this[y] = +w;
      };
    }, a = [/[+-]\d\d:?(\d\d)?|Z/, function(y) {
      (this.zone || (this.zone = {})).offset = function(w) {
        if (!w || w === "Z")
          return 0;
        var p = w.match(/([+-]|\d\d)/g), B = 60 * p[1] + (+p[2] || 0);
      ...
      this.milliseconds = +y;
    }], s: [l, n("seconds")], ss: [l, n("seconds")], m: [l, n("minutes")], mm: [l, n("minutes")], H: [l, n("hours")], h: [l, n("hours")], HH: [l, n("hours")], hh: [l, n("hours")], D: [l, n("day")], DD: [v, n("day")], Do: [u, function(y) {
      var w = s.ordinal, p = y.match(/\d+/);
      if (this.day = p[0], w)
        for (var B = 1; B <= 31; B += 1)
          w(B).replace(/\[|\]/g, "") === y && (this.day = B);
    }], M: [l, n("month")], MM: [v, n("month")], MMM: [u, function(y) {
      var w = f("months"), p = (f("monthsShort") || w.map(function(B) {
        return B.slice(0, 3);
      })).indexOf(y) + 1;
      if (p < 1)
        throw new Error();
      ...
      var w = f("months").indexOf(y) + 1;
      if (w < 1)
        throw new Error();
      this.month = w % 12 || w;
    }], Y: [/[+-]?\d+/, n("year")], YY: [v, function(y) {
      this.year = o(y);
    }], YYYY: [/\d{4}/, n("year")], Z: a, ZZ: a };
    function k(y) {
      var w, p;
      w = y, p = s && s.formats;
      for (var B = (y = w.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(C, M, O) {
        var S = O && O.toUpperCase();
        return M || p[O] || i[O] || p[S].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(G, A, P) {
          return A || P.slice(1);
        });
    ...
    return function(y, w, p) {
      p.p.customParseFormat = !0, y && y.parseTwoDigitYear && (o = y.parseTwoDigitYear);
      var B = w.prototype, m = B.parse;
      B.parse = function(b) {
        ...
        if (typeof _ == "string") {
          ...
          M && (S = d[2]), s = this.$locale(), !C && S && (s = p.Ls[S]), this.$d = function(F, N, j) {
            try {
              if (["x", "X"].indexOf(N) > -1)
...
function Qt() {
  const { precision: t } = W(), { chartStartDayjs: c, chartEndDayjs: i } = ot(), r = H(() => {
    ...
    for (; x.isSameOrBefore(i.value); ) {
      const k = x.endOf(f), w = k.isAfter(i.value) ? i.value.diff(x, "minutes", !0) / n * 100 : k.diff(x, "minutes", !0) / n * 100;
      o.push({
    ...
    for (; g.isSameOrBefore(i.value); ) {
      const k = g.endOf(a), w = k.isAfter(i.value) ? i.value.diff(g, "minutes", !0) / n * 100 : k.diff(g, "minutes", !0) / n * 100;
      s.push({
        label: g.format(l[a]),
        value: String(g),
        date: g.toDate(),
...
const xe = { class: "g-timeaxis" }, Be = { class: "g-timeunits-container g-timeunits-low" }, _e = {
  ...
  setup(t) {
    ...
    return (v, l) => (E(), T("div", xe, [
      ...
      $("div", ke, [
        (E(!0), T(K, null, et(D(r).upperUnits, ({ label: u, value: s, date: o, width: n }) => (E(), T("div", {
          key: u,
...
const De = "cadetblue", Ee = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    }, { bar: r } = at(c), { precision: v, font: l, barStart: u, barEnd: s, rowHeight: o } = W(), n = L("0px"), a = L("0px");
    ft(
      () => c.bar,
      async () => {
        var e;
        await Yt();
        const w = ((e = r == null ? void 0 : r.value) == null ? void 0 : e.ganttBarConfig.id) || "";
        if (!w)
          return;
        const p = document.getElementById(w), { top: B, left: m } = (p == null ? void 0 : p.getBoundingClientRect()) || {
          top: 0,
          left: 0
        }, b = Math.max(m, 10);
    ...
    const f = H(() => {
      var w, p;
      return ((p = (w = r == null ? void 0 : r.value) == null ? void 0 : w.ganttBarConfig.style) == null ? void 0 : p.background) || De;
    }), { toDayjs: g } = ot(), x = H(() => {
      var w;
      return (w = r.value) == null ? void 0 : w[u.value];
    }), k = H(() => {
      var w;
      return (w = r.value) == null ? void 0 : w[s.value];
    }), y = H(() => {
      if (!(r != null && r.value))
        return "";
      const w = i[v.value], p = g(x.value).format(w), B = g(k.value).format(w);
      return `${p} \u2013 ${B}`;
    });
    return (w, p) => (E(), tt(ne, { to: "body" }, [
      ct(re, {
        name: "g-fade",
        mode: "out-in"
      }, {
        default: q(() => [
          w.modelValue ? (E(), T("div", {
            key: 0,
...
const Oe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { mapTimeToPosition: c } = gt(), i = L(R()), { colors: r, dateFormat: v, currentTimeLabel: l } = W(), u = H(() => {
...
function He(t, c, i = {}) {
  const r = i, { window: v = Le } = r, l = Re(r, ["window"]);
  let u;
...
function Ae(t, c = { width: 0, height: 0 }, i = {}) {
  const r = L(c.width), v = L(c.height);
  return He(t, ([l]) => {
...
function Lt(t, c = () => null, i = () => null, r = W()) {
  const { barStart: v, barEnd: l, pushOnOverlap: u } = r, s = L(!1);
  let o = 0, n;
...
function Je() {
  const t = W(), c = kt(), i = Xt(), { pushOnOverlap: r, barStart: v, barEnd: l, noOverlap: u, dateFormat: s } = t, o = /* @__PURE__ */ new Map(), { toDayjs: n, format: a } = ot(), f = (e, h) => {
    ...
    if (!(r != null && r.value))
      return;
    let h = e, { overlapBar: d, overlapType: _ } = y(h);
    for (; d; ) {
      m(d);
      const C = n(h[v.value]), M = n(h[l.value]), O = n(d[v.value]), S = n(d[l.value]);
      let G;
      switch (_) {
        case "left":
          G = S.diff(C, "minutes", !0), d[l.value] = a(h[v.value], s.value), d[v.value] = a(
      ...
      d && (_ === "left" || _ === "right") && w(d, G, _), h = d, { overlapBar: d, overlapType: _ } = y(d);
    }
  }, y = (e) => {
    var A, P;
    let h, d, _;
  ...
  const { pushOnOverlap: t } = W(), c = kt(), i = (u) => {
    ...
    for (const o of ["left", "right"]) {
      ...
      for (let y = 0; y < x.length; y++) {
        const w = x[y].bar, p = x[y].gapDistance;
    ...
    return s === "left" ? a = n.filter((x) => {
      ...
      const y = document.getElementById(x.ganttBarConfig.id), w = document.getElementById(k.ganttBarConfig.id), p = Math.abs(y.offsetLeft - o.offsetLeft), B = Math.abs(w.offsetLeft - o.offsetLeft);
      return p < B ? x : k;
    }, a[0]) : null;
  };
  return {
...
const en = ["id"], nn = { class: "g-gantt-bar-label" }, rn = ["innerHTML"], an = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-left" }, null, -1), on = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-right" }, null, -1), sn = 8, ln = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    const n = L(!1), a = H(() => l.value.ganttBarConfig), f = dt(Nt), g = (d) => {
      ...
      i(d, l.value, C);
    }, { barStart: x, barEnd: k, width: y, chartStart: w, chartEnd: p, chartSize: B } = r, m = L(0), b = L(0), e = H(() => {
...
const un = /* @__PURE__ */ V({
  ...
  emits: ["drop"],
  setup(t, { emit: c }) {
    const i = t, r = L([]), { rowHeight: v, colors: l, labelColumnTitle: u } = W(), { highlightOnHover: s } = at(i), o = L(!1), n = H(() => ({
      height: `${v.value}px`,
...
.g-gantt-bar-arrow {
  ...
  width: 0;
  height: 0;
  border-left: 8px solid var(--9ab65240);
