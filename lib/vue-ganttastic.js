...
const $o = /* @__PURE__ */ it(Po, [["__scopeId", "data-v-55611549"]]), Bo = { class: "g-gantt-legend-collapse" }, Lo = { class: "g-gantt-legend-areas-list" }, Ro = { class: "g-gantt-legend-title" }, Io = { class: "g-gantt-legend-area" }, jo = { class: "g-gantt-legend-category-name" }, Ho = 6, Go = /* @__PURE__ */ Z({
...
const Yo = /* @__PURE__ */ it(Go, [["__scopeId", "data-v-7e09252c"]]), Uo = { class: "g-gantt-legend" }, Wo = /* @__PURE__ */ Z({
  __name: "GGanttLegend",
  props: {
    legend: {}
  },
      ...
      B("div", {
        ...
        p.labelColumnTitle ? (A(), _e(xo, {
          ...
          "label-column-row": ze(({ label: _ }) => [
            ee(p.$slots, "label-column-row", { label: _ })
          ]),
          _: 3
        }, 8, ["style"])) : ie("", !0),
        B("div", {
...
function xt(e) {
  for (var t = xe(e), n = _n(e); n && ca(n) && Ee(n).position === "static"; )
    n = _n(n);
...
function Ua(e) {
  ...
  if (!!y) {
    if (i) {
      var I, H = s === "y" ? ne : re, z = s === "y" ? fe : pe, F = s === "y" ? "height" : "width", N = y[s], W = N + C[H], V = N - C[z], X = x ? -T[F] / 2 : 0, se = f === et ? h[F] : T[F], le = f === et ? -T[F] : -h[F], Ae = t.elements.arrow, ge = x && Ae ? rn(Ae) : {
        width: 0,
        height: 0
      }, oe = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : dr(), he = oe[H], Se = oe[z], ae = dt(0, h[F], ge[F]), Oe = _ ? h[F] / 2 - X - ae - he - E.mainAxis : se - ae - he - E.mainAxis, ue = _ ? -h[F] / 2 + X + ae + Se + E.mainAxis : le + ae + Se + E.mainAxis, me = t.elements.arrow && xt(t.elements.arrow), $e = me ? s === "y" ? me.clientTop || 0 : me.clientLeft || 0 : 0, Me = (I = S == null ? void 0 : S[s]) != null ? I : 0, Be = N + Oe - Me - $e, Le = N + ue - Me, Ke = dt(x ? Rt(W, Be) : W, N, x ? Ve(V, Le) : V);
      y[s] = Ke, M[s] = Ke - N;
    }
    if (l) {
      var st, Ot = s === "x" ? ne : re, Ct = s === "x" ? fe : pe, Pe = y[m], Re = m === "y" ? "height" : "width", lt = Pe + C[Ot], Ye = Pe - C[Ct], ut = [ne, re].indexOf(p) !== -1, _t = (st = S == null ? void 0 : S[m]) != null ? st : 0, Tt = ut ? lt : Pe - h[Re] - T[Re] - _t + E.altAxis, kt = ut ? Pe + h[Re] + T[Re] - _t - E.altAxis : Ye, Dt = x && ut ? fa(Tt, Pe, kt) : dt(x ? Tt : lt, Pe, x ? kt : Ye);
      y[m] = Dt, M[m] = Dt - Pe;
    }
    t.modifiersData[r] = M;
  }
...
`, "top");
ve(`
.g-gantt-legend-collapse[data-v-55611549] {
  display: flex;
  align-items: center;
...
.g-gantt-legend-area-icon[data-v-55611549] {
  margin: 0 8px 0 16px;
}
.g-gantt-legend-promotion[data-v-55611549] {
  display: flex;
  flex-direction: column;
  gap: 4px;
}
.g-gantt-legend-areas-list[data-v-55611549] {
  display: flex;
  flex-direction: column;
}
.g-gantt-legend-area-list[data-v-55611549] {
  display: flex;
  flex-direction: column;
  gap: 6px;
}
.g-gantt-legend-do-collapse[data-v-55611549]:hover {
  cursor: pointer;
  color: #008075;
}
.g-gantt-legend-category-color[data-v-55611549] {
  width: 44px;
  height: 6px;
...
`, "top");
ve(`
.g-gantt-legend-collapse[data-v-7e09252c] {
  display: flex;
  align-items: center;
  justify-content: flex-end;
...
.g-gantt-legend-title[data-v-7e09252c] {
  display: flex;
  align-items: center;
  gap: 12px;
...
.g-gantt-legend-area[data-v-7e09252c] {
  font-size: 16px;
  font-weight: 700;
  line-height: 24.8px;
...
.g-gantt-legend-category-color[data-v-7e09252c] {
  width: 60px;
  height: 6px;
...
.g-gantt-legend-promotion[data-v-7e09252c] {
  display: flex;
  align-items: center;
  gap: 8px;
}
.g-gantt-legend-do-uncollapse[data-v-7e09252c]:hover {
  cursor: pointer;
  color: #008075;
}
.g-gantt-legend-area-list[data-v-7e09252c] {
  display: flex;
  flex-direction: column;
  gap: 6px;
}
.g-gantt-legend-category-name[data-v-7e09252c] {
  font-size: 14px;
  font-weight: 400;
  line-height: 18.2px;
