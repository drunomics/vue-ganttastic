  ...
  (function(i, r) {
    ...
    var i = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, r = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, m = /\d\d/, l = /\d\d?/, u = /\d*[^-_:/,()\s\d]+/, a = {}, s = function(d) {
      ...
      (this.zone || (this.zone = {})).offset = function(w) {
        if (!w || w === "Z")
          return 0;
        var k = w.match(/([+-]|\d\d)/g), B = 60 * k[1] + (+k[2] || 0);
      ...
      var w = a.ordinal, k = d.match(/\d+/);
      if (this.day = k[0], w)
        for (var B = 1; B <= 31; B += 1)
          w(B).replace(/\[|\]/g, "") === d && (this.day = B);
    }], M: [l, e("month")], MM: [m, e("month")], MMM: [u, function(d) {
      var w = h("months"), k = (h("monthsShort") || w.map(function(B) {
        return B.slice(0, 3);
      })).indexOf(d) + 1;
      if (k < 1)
        throw new Error();
    ...
    function b(d) {
      ...
      return function(D) {
        ...
        return function(j) {
          ...
          if (z !== void 0) {
            var tt = j.hours;
            z ? tt < 12 && (j.hours += 12) : tt === 12 && (j.hours = 0), delete j.afternoon;
          }
        }(M), M;
      };
    }
    return function(d, w, k) {
      k.p.customParseFormat = !0, d && d.parseTwoDigitYear && (s = d.parseTwoDigitYear);
      var B = w.prototype, y = B.parse;
      B.parse = function(_) {
        ...
        if (typeof x == "string") {
          ...
          M && (L = f[2]), a = this.$locale(), !D && L && (a = k.Ls[L]), this.$d = function(N, q, j) {
            try {
              if (["x", "X"].indexOf(q) > -1)
                return new Date((q === "X" ? 1e3 : 1) * N);
              var z = b(q)(N), tt = z.year, lt = z.month, ee = z.day, ne = z.hours, re = z.minutes, ae = z.seconds, oe = z.milliseconds, _t = z.zone, ht = new Date(), pt = ee || (tt || lt ? 1 : ht.getDate()), mt = tt || ht.getFullYear(), ut = 0;
              tt && !lt || (ut = lt > 0 ? lt - 1 : ht.getMonth());
              var vt = ne || 0, bt = re || 0, wt = ae || 0, yt = oe || 0;
              return _t ? new Date(Date.UTC(mt, ut, pt, vt, bt, wt, yt + 60 * _t.offset * 1e3)) : j ? new Date(Date.UTC(mt, ut, pt, vt, bt, wt, yt)) : new Date(mt, ut, pt, vt, bt, wt, yt);
            } catch {
              return new Date("");
            }
...
function Zt() {
  const { precision: t } = U(), { chartStartDayjs: c, chartEndDayjs: i } = it(), r = R(() => {
    ...
    for (; g.isSameOrBefore(i.value); ) {
      const b = g.endOf(h), w = b.isAfter(i.value) ? i.value.diff(g, "minutes", !0) / e * 100 : b.diff(g, "minutes", !0) / e * 100;
      s.push({
    ...
    for (; p.isSameOrBefore(i.value); ) {
      const b = p.endOf(o), w = b.isAfter(i.value) ? i.value.diff(p, "minutes", !0) / e * 100 : b.diff(p, "minutes", !0) / e * 100;
      a.push({
        label: p.format(l[o]),
        value: String(p),
        date: p.toDate(),
...
const we = { class: "g-grid-container" }, Ot = /* @__PURE__ */ V({
  __name: "GGanttGrid",
  props: {
    highlightedUnits: {}
  },
  setup(t) {
    const { colors: c } = U(), { timeaxisUnits: i } = Zt(), r = (l) => {
...
const ye = { class: "g-label-column-rows" }, xe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { font: c, colors: i, labelColumnTitle: r, rowHeight: m } = U(), l = Bt();
    return (u, a) => (E(), O("div", {
...
const ke = { class: "g-timeaxis" }, Be = { class: "g-timeunits-container g-timeunits-low" }, _e = {
  ...
  setup(t) {
    const { precision: c, colors: i } = U(), { timeaxisUnits: r } = Zt();
...
const Ee = "cadetblue", Oe = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    }, { bar: r } = at(c), { precision: m, font: l, barStart: u, barEnd: a, rowHeight: s } = U(), e = I("0px"), o = I("0px");
    ft(
      () => c.bar,
      async () => {
        var n;
        await Rt();
        const w = ((n = r == null ? void 0 : r.value) == null ? void 0 : n.ganttBarConfig.id) || "";
        if (!w)
          return;
        const k = document.getElementById(w), { top: B, left: y } = (k == null ? void 0 : k.getBoundingClientRect()) || {
          top: 0,
          left: 0
        }, _ = Math.max(y, 10);
    ...
    const h = R(() => {
      var w, k;
      return ((k = (w = r == null ? void 0 : r.value) == null ? void 0 : w.ganttBarConfig.style) == null ? void 0 : k.background) || Ee;
    }), { toDayjs: p } = it(), g = R(() => {
      var w;
      return (w = r.value) == null ? void 0 : w[u.value];
    }), b = R(() => {
      var w;
      return (w = r.value) == null ? void 0 : w[a.value];
    }), d = R(() => {
      if (!(r != null && r.value))
        return "";
      const w = i[m.value], k = p(g.value).format(w), B = p(b.value).format(w);
      return `${k} \u2013 ${B}`;
    });
    return (w, k) => (E(), K(ie, { to: "body" }, [
      ot(se, {
        name: "g-fade",
        mode: "out-in"
      }, {
        default: P(() => [
          w.modelValue ? (E(), O("div", {
            key: 0,
...
const Te = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { mapTimeToPosition: c } = gt(), i = I(H()), { colors: r, dateFormat: m, currentTimeLabel: l } = U(), u = R(() => {
...
var Ue = Object.defineProperty, St = Object.getOwnPropertySymbols, je = Object.prototype.hasOwnProperty, ze = Object.prototype.propertyIsEnumerable, Lt = (t, c, i) => c in t ? Ue(t, c, { enumerable: !0, configurable: !0, writable: !0, value: i }) : t[c] = i, Pe = (t, c) => {
  for (var i in c || (c = {}))
    je.call(c, i) && Lt(t, i, c[i]);
  if (St)
    for (var i of St(c))
    ...
    const w = (n) => {
      ...
      switch (n.type) {
        ...
        case "dblclick":
          ...
          break;
        case "mouseenter":
          w(v), c("mouseenter-bar", { bar: v, e: n });
          break;
        case "mouseleave":
    ...
    return document.getElementsByClassName("g-timeunit-low"), ct(qt, h), ct(Qt, {
      ...
      $("div", {
        ...
        n.labelColumnTitle ? (E(), K(xe, {
          ...
          "label-column-title": P(() => [
            Y(n.$slots, "label-column-title")
          ]),
          "label-column-row": P(({ label: f }) => [
        ...
        $("div", {
          ...
          n.hideTimeaxis ? A("", !0) : (E(), K(De, { key: 2 }, {
            "upper-timeunit": P(({ label: f, value: x, date: D }) => [
            ...
            timeunit: P(({ label: f, value: x, date: D }) => [
              Y(n.$slots, "timeunit", {
                label: f,
                value: x,
                date: D
...
function Gt(t, c = () => null, i = () => null, r = U()) {
  const { barStart: m, barEnd: l, pushOnOverlap: u } = r, a = I(!1);
  let s = 0, e;
  const { mapPositionToTime: o } = gt(r), { toDayjs: h } = it(r), p = (y) => {
    const _ = document.getElementById(t.ganttBarConfig.id);
    if (!_)
      return;
    switch (s = y.clientX - (_.getBoundingClientRect().left || 0), y.target.className) {
      case "g-gantt-bar-handle-left":
        document.body.style.cursor = "ew-resize", e = d;
        break;
      case "g-gantt-bar-handle-right":
        document.body.style.cursor = "ew-resize", e = w;
        break;
      default:
        e = b;
    }
    ...
    var n;
    const y = document.getElementById(t.ganttBarConfig.id), _ = (n = y == null ? void 0 : y.closest(".g-gantt-row-bars-container")) == null ? void 0 : n.getBoundingClientRect();
    return { barElement: y, barContainer: _ };
  }, b = (y) => {
    const { barElement: _, barContainer: n } = g();
    if (!_ || !n)
      return;
    const v = _.getBoundingClientRect().width, f = y.clientX - n.left - s, x = f + v;
    k(f, x) || (t[m.value] = o(f), t[l.value] = o(x), c(y, t));
  }, d = (y) => {
    const { barElement: _, barContainer: n } = g();
    if (!_ || !n)
      return;
    const v = y.clientX - n.left, f = o(v);
    h(f).isSameOrAfter(h(t, "end")) || (t[m.value] = f, c(y, t));
  }, w = (y) => {
    const { barElement: _, barContainer: n } = g();
    if (!_ || !n)
      return;
    const v = y.clientX - n.left, f = o(v);
    h(f).isSameOrBefore(h(t, "start")) || (t[l.value] = f, c(y, t));
  }, k = (y, _) => {
    if (!u.value)
      return !1;
    const n = t.ganttBarConfig.dragLimitLeft, v = t.ganttBarConfig.dragLimitRight;
    return y && n != null && y < n || _ && v != null && _ > v;
  }, B = (y) => {
    a.value = !1, document.body.style.cursor = "", window.removeEventListener("mousemove", e), window.removeEventListener("mouseup", B), i(y, t);
  };
  return {
    isDragging: a,
    initDrag: p
...
function tn() {
  const t = U(), c = Bt(), i = te(), { pushOnOverlap: r, barStart: m, barEnd: l, noOverlap: u, dateFormat: a } = t, s = /* @__PURE__ */ new Map(), { toDayjs: e, format: o } = it(), h = (n, v) => {
    const { initDrag: f } = Gt(n, g, B, t);
    i({ ...v, type: "dragstart" }, n), f(v), y(n);
  }, p = (n, v) => {
    ...
    for (; f; ) {
      ...
      f && (x === "left" || x === "right") && w(f, G, x), v = f, { overlapBar: f, overlapType: x } = d(f);
    }
  }, d = (n) => {
    var W, F;
    let v, f, x;
    ...
    return { overlapBar: D.find((N) => {
      if (N === n)
        return !1;
      const q = e(N[m.value]), j = e(N[l.value]);
      return v = M.isBetween(q, j), f = T.isBetween(q, j), x = q.isBetween(M, T) || j.isBetween(M, T), v || f || x;
    }), overlapType: v ? "left" : f ? "right" : x ? "between" : null };
  }, w = (n, v, f) => {
    y(n), n.ganttBarConfig.bundle && c().forEach((x) => {
      x.bars.forEach((D) => {
        D.ganttBarConfig.bundle === n.ganttBarConfig.bundle && D !== n && (y(D), k(D, v, f));
      });
    });
  }, k = (n, v, f) => {
    switch (f) {
...
function en() {
  const { pushOnOverlap: t } = U(), c = Bt(), i = (u) => {
    const a = [];
    ...
    for (const s of ["left", "right"]) {
      ...
      for (let d = 0; d < g.length; d++) {
        const w = g[d].bar, k = g[d].gapDistance;
        i(w.ganttBarConfig.bundle).filter(
          (y) => y !== w
        ).forEach((y) => {
          const _ = m(y, k, e), n = _.gapDistanceSoFar, v = _.bundleBarsAndGapDist;
    ...
    return a === "left" ? o = e.filter((g) => {
      ...
      const d = document.getElementById(g.ganttBarConfig.id), w = document.getElementById(b.ganttBarConfig.id), k = Math.abs(d.offsetLeft - s.offsetLeft), B = Math.abs(w.offsetLeft - s.offsetLeft);
      return k < B ? g : b;
    }, o[0]) : null;
  };
  return {
...
const nn = ["id"], rn = { class: "g-gantt-bar-label" }, an = ["innerHTML"], on = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-left" }, null, -1), sn = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-right" }, null, -1), ln = 8, It = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    const i = te(), r = U(), { rowHeight: m } = r, { bar: l } = at(c), u = (v = c.bar.ganttBarConfig.style) == null ? void 0 : v.backgroundColor, { mapTimeToPosition: a, mapPositionToTime: s } = gt();
    tn(), en();
    const e = I(!1), o = R(() => l.value.ganttBarConfig), h = dt(Xt), p = (f) => {
      ...
      i(f, l.value, D);
    }, { barStart: g, barEnd: b, width: d, chartStart: w, chartEnd: k, chartSize: B } = r, y = I(0), _ = I(0), n = R(() => {
      const f = new Date(l.value.myBeginDate).getTime(), x = new Date(l.value.myEndDate).getTime();
      return Math.abs(f - x) / (1e3 * 60 * 60 * 24) <= 2 ? 0 : _.value - y.value - ln;
    });
    return Ht(() => {
      ft(
        [l, d, w, k, B.width],
        () => {
          y.value = a(l.value[g.value]), _.value = a(l.value[b.value]);
        },
        { deep: !0, immediate: !0 }
      );
    }), (f, x) => {
...
const un = /* @__PURE__ */ V({
  ...
  emits: ["drop"],
  setup(t, { emit: c }) {
    const i = t, { rowHeight: r, colors: m, labelColumnTitle: l } = U(), { highlightOnHover: u } = at(i), a = I(!1), s = R(() => ({
      height: `${r.value}px`,
    ...
    const h = (g) => {
      ...
      const d = g.clientX - b.left, w = e(d);
      c("drop", { e: g, datetime: w });
    }, p = (g) => !g || /^\s*$/.test(g);
...
function cn() {
  H.extend(he), H.extend(pe), H.extend(zt), H.extend(be), H.extend(me), H.extend(ge), H.extend(ve);
}
const hn = {
  install(t, c) {
