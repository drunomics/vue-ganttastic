  ...
  (function(n, r) {
    ...
    return function(r, a, s) {
      ...
      l.isoWeekYear = function() {
        ...
        var c, m, y, O, C = i(this), g = (c = this.isoWeekYear(), m = this.$u, y = (m ? s.utc : s)().year(c).startOf("year"), O = 4 - y.isoWeekday(), y.isoWeekday() > 4 && (O += 7), y.add(O, n));
  ...
  (function(n, r) {
    ...
    return function(a, s, i) {
      ...
      l.week = function(u) {
        ...
        var y = i(this).startOf(r).date(d).startOf(n).subtract(1, "millisecond"), O = this.diff(y, n, !0);
...
(function(e, t) {
  (function(n, r) {
    ...
    var n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, r = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, a = /\d\d/, s = /\d\d?/, i = /\d*[^-_:/,()\s\d]+/, l = {}, u = function(g) {
      ...
      this.milliseconds = +g;
    }], s: [s, d("seconds")], ss: [s, d("seconds")], m: [s, d("minutes")], mm: [s, d("minutes")], H: [s, d("hours")], h: [s, d("hours")], HH: [s, d("hours")], hh: [s, d("hours")], D: [s, d("day")], DD: [a, d("day")], Do: [i, function(g) {
      var _ = l.ordinal, f = g.match(/\d+/);
      if (this.day = f[0], _)
        for (var x = 1; x <= 31; x += 1)
          _(x).replace(/\[|\]/g, "") === g && (this.day = x);
    }], M: [s, d("month")], MM: [a, d("month")], MMM: [i, function(g) {
...
function tr() {
  const { precision: e } = He(), { chartStartDayjs: t, chartEndDayjs: n } = Jt(), r = q(() => {
    ...
    for (; O.isSameOrBefore(n.value); ) {
      ...
      u.push({
        label: O.format(s[e == null ? void 0 : e.value]),
        value: String(O),
        date: O.toDate(),
        width: String(_) + "%"
...
const pa = /* @__PURE__ */ ee({
  ...
  setup(e) {
    ...
    return (a, s) => (S(), L(ne, null, [
      (S(!0), L(ne, null, be(a.areaHeights, (i) => (S(), L("div", {
        key: i,
        style: F({
          position: "absolute",
          top: i + "px",
      ...
      (S(!0), L(ne, null, be(B(t).lowerUnits, ({ label: i, width: l }, u) => (S(), L("div", {
        key: i,
        style: F({
          width: l,
          borderRight: n(i, u),
...
const ha = { class: "g-label-column-rows" }, ma = /* @__PURE__ */ ee({
  ...
  setup(e) {
    ...
    return (i, l) => (S(), L("div", {
      ...
      $("div", ha, [
        (S(!0), L(ne, null, be(B(s)(), ({ label: u }, d) => (S(), L("div", {
          key: `${u}_${d}`,
...
const ya = { class: "g-timeaxis" }, ba = { class: "g-timeunits-container g-timeunits-low" }, wa = {
  ...
  setup(e) {
    ...
    return (a, s) => (S(), L("div", ya, [
      $("div", ba, [
        (S(!0), L(ne, null, be(B(r).lowerUnits, ({ label: i, value: l, date: u, width: d }, c) => (S(), L("div", {
          key: i,
      ...
      $("div", xa, [
        (S(!0), L(ne, null, be(B(r).upperUnits, ({ label: i, value: l, date: u, width: d }) => (S(), L("div", {
          key: i,
...
function en(e = He()) {
  ...
  return {
    mapTimeToPosition: (c) => {
      const m = n.width.value || 0, y = s(c).diff(r.value, "minutes", !0);
      return Math.ceil(y / l.value * m);
    },
    mapPositionToTime: (c) => {
      const m = n.width.value || 0, y = c / m * l.value;
      return i(r.value.add(y, "minutes"), t.value);
    }
  };
}
...
const Ha = /* @__PURE__ */ wt(ja, [["__scopeId", "data-v-31a73749"]]), Ya = /* @__PURE__ */ ee({
  ...
  setup(e, { emit: t }) {
    ...
    const s = U(
      ...
      switch (f.type) {
        case "click":
          i("click-bar", { bar: x, e: f, datetime: w });
          break;
        case "mousedown":
          i("mousedown-bar", { bar: x, e: f, datetime: w });
          break;
        case "mouseup":
          i("mouseup-bar", { bar: x, e: f, datetime: w });
          break;
        case "dblclick":
          i("dblclick-bar", { bar: x, e: f, datetime: w });
          break;
        case "mouseenter":
          i("mouseenter-bar", { bar: x, e: f });
          break;
        case "mouseleave":
          i("mouseleave-bar", { bar: x, e: f });
          break;
        case "dragstart":
          O.value = !0, i("dragstart-bar", { bar: x, e: f });
          break;
        case "drag":
          i("drag-bar", { bar: x, e: f });
          break;
        case "dragend":
          O.value = !1, i("dragend-bar", { bar: x, e: f, movedBars: o });
          break;
        case "contextmenu":
          i("contextmenu-bar", { bar: x, e: f, datetime: w });
          break;
      }
    }, g = U(null), _ = Xn(g);
...
function ao(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !fe(s) || !ke(s) || (Object.assign(s.style, r), Object.keys(a).forEach(function(i) {
      var l = a[i];
...
function oo(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !fe(a) || !ke(a) || (Object.assign(a.style, l), Object.keys(s).forEach(function(u) {
        a.removeAttribute(u);
      }));
    });
  };
...
function co(e) {
  ...
  if (!(!s || !i)) {
    var m = uo(a.padding, n), y = nn(s), O = u === "y" ? re : ae, C = u === "y" ? pe : ge, g = n.rects.reference[c] + n.rects.reference[u] - i[u] - n.rects.popper[c], _ = i[u] - n.rects.reference[u], f = Ot(s), x = f ? u === "y" ? f.clientHeight || 0 : f.clientWidth || 0 : 0, w = g / 2 - _ / 2, o = m[O], b = x - y[c] - m[C], p = x / 2 - y[c] / 2 + w, h = ct(o, p, b), T = u;
...
function On(e) {
  var t, n = e.popper, r = e.popperRect, a = e.placement, s = e.variation, i = e.offsets, l = e.position, u = e.gpuAcceleration, d = e.adaptive, c = e.roundOffsets, m = e.isFixed, y = c === !0 ? vo(i) : typeof c == "function" ? c(i) : i, O = y.x, C = O === void 0 ? 0 : O, g = y.y, _ = g === void 0 ? 0 : g, f = i.hasOwnProperty("x"), x = i.hasOwnProperty("y"), w = ae, o = re, b = window;
  if (d) {
    var p = Ot(n), h = "clientHeight", T = "clientWidth";
    if (p === we(n) && (p = Ye(n), De(p).position !== "static" && l === "absolute" && (h = "scrollHeight", T = "scrollWidth")), p = p, a === re || (a === ae || a === ge) && s === vt) {
      o = pe;
...
function Co(e) {
  ...
  return De(a || n).direction === "rtl" && (l += Ve(n.clientWidth, a ? a.clientWidth : 0) - s), {
    width: s,
    height: i,
    x: l,
    y: u
...
function ko(e, t, n) {
  var r = t === "clippingParents" ? To(e) : [].concat(t), a = [].concat(r, [n]), s = a[0], i = a.reduce(function(l, u) {
    var d = _n(e, u);
...
function ht(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, a = r === void 0 ? e.placement : r, s = n.boundary, i = s === void 0 ? Na : s, l = n.rootBoundary, u = l === void 0 ? nr : l, d = n.elementContext, c = d === void 0 ? ut : d, m = n.altBoundary, y = m === void 0 ? !1 : m, O = n.padding, C = O === void 0 ? 0 : O, g = lr(typeof C != "number" ? C : ur(C, xt)), _ = c === ut ? Va : ut, f = e.rects.popper, x = e.elements[y ? _ : c], w = ko(tt(x) ? x : x.contextElement || Ye(e.elements.popper), i, u), o = rt(e.elements.reference), b = dr({
    reference: o,
    element: f,
    strategy: "absolute",
    placement: a
...
function Do(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, a = n.boundary, s = n.rootBoundary, i = n.padding, l = n.flipVariations, u = n.allowedAutoPlacements, d = u === void 0 ? rr : u, c = at(r), m = c ? l ? wn : wn.filter(function(C) {
    return at(C) === c;
...
function So(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var a = n.mainAxis, s = a === void 0 ? !0 : a, i = n.altAxis, l = i === void 0 ? !0 : i, u = n.fallbackPlacements, d = n.padding, c = n.boundary, m = n.rootBoundary, y = n.altBoundary, O = n.flipVariations, C = O === void 0 ? !0 : O, g = n.allowedAutoPlacements, _ = t.options.placement, f = _e(_), x = f === _, w = u || (x || !C ? [Rt(_)] : Eo(_)), o = [_].concat(w).reduce(function(ve, oe) {
      ...
      b[z] > p[z] && (W = Rt(W));
      var Y = Rt(W), V = [];
      if (s && V.push(N[D] <= 0), l && V.push(N[W] <= 0, N[Y] <= 0), V.every(function(ve) {
        return ve;
      })) {
        M = A, T = !1;
        break;
...
function Mo(e) {
  var t = e.state, n = e.name, r = t.rects.reference, a = t.rects.popper, s = t.modifiersData.preventOverflow, i = ht(t, {
    ...
    altBoundary: !0
  }), u = Tn(i, r), d = Tn(l, a, s), c = kn(u), m = kn(d);
  t.modifiersData[n] = {
...
function Ho(e) {
  var t = e.state, n = e.options, r = e.name, a = n.mainAxis, s = a === void 0 ? !0 : a, i = n.altAxis, l = i === void 0 ? !1 : i, u = n.boundary, d = n.rootBoundary, c = n.altBoundary, m = n.padding, y = n.tether, O = y === void 0 ? !0 : y, C = n.tetherOffset, g = C === void 0 ? 0 : C, _ = ht(t, {
    boundary: u,
    rootBoundary: d,
    padding: m,
    altBoundary: c
...
function Wo(e, t, n) {
  n === void 0 && (n = !1);
  var r = fe(t), a = fe(t) && zo(t), s = Ye(t), i = rt(e, a), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, u = {
    x: 0,
  ...
  return (r || !r && !n) && ((ke(t) !== "body" || sn(s)) && (l = Uo(t)), fe(t) ? (u = rt(t, !0), u.x += t.clientLeft, u.y += t.clientTop) : s && (u.x = on(s))), {
...
function Xo(e) {
  e === void 0 && (e = {});
  var t = e, n = t.defaultModifiers, r = n === void 0 ? [] : n, a = t.defaultOptions, s = a === void 0 ? Dn : a;
...
function oi(e, t) {
  ...
  return e.every(function(a) {
    ...
    if (!c)
      return !0;
    var m = d === "bottom" ? c.top.y : 0, y = d === "top" ? c.bottom.y : 0, O = d === "right" ? c.left.x : 0, C = d === "left" ? c.right.x : 0, g = s.top - r + m > u, _ = r - s.bottom - y > u, f = s.left - n + O > u, x = n - s.right - C > u;
    return g || _ || f || x;
  });
}
function Ft(e, t, n) {
...
var mi = 1, Pt = [], Nt = [];
function yi(e, t) {
  var n = Bn(e, Object.assign({}, ye, xr(Mn(t)))), r, a, s, i = !1, l = !1, u = !1, d = !1, c, m, y, O = [], C = Sn(Be, n.interactiveDebounce), g, _ = mi++, f = null, x = ti(n.plugins), w = {
    isEnabled: !0,
    isVisible: !1,
    isDestroyed: !1,
    isMounted: !1,
  ...
  function Ae(v) {
    ...
    if (!(!o.state.isEnabled || it(v) || l)) {
      ...
      c = v, g = v.currentTarget, X(), !o.state.isVisible && un(v) && Pt.forEach(function(I) {
        return I(v);
      }), v.type === "click" && (o.props.trigger.indexOf("mouseenter") < 0 || i) && o.props.hideOnClick !== !1 && o.state.isVisible ? P = !0 : st(v), v.type === "click" && (i = !P), P && !G && Ge(v);
    }
  }
  function Be(v) {
  ...
  function Le(v) {
    var k = it(v) || o.props.trigger.indexOf("click") >= 0 && i;
    if (!k) {
  ...
  function Ge(v) {
    ...
    if (!(o.props.trigger.indexOf("mouseenter") >= 0 && o.props.trigger.indexOf("click") >= 0 && ["mouseleave", "mousemove"].indexOf(v.type) >= 0 && i)) {
      var k = N(!1);
  ...
  function kr() {
    ...
    if (!(v || k || P) && (Y("onHide", [o], !1), o.props.onHide(o) !== !1)) {
      if (o.state.isVisible = !1, o.state.isShown = !1, d = !1, i = !1, D() && (p.style.visibility = "hidden"), se(), he(), W(!0), D()) {
...
function E(e, t) {
  ...
  var r = Object.assign({}, t, {
    plugins: n
  }), a = ai(e), s = a.reduce(function(i, l) {
    var u = l && yi(l, r);
    return u && i.push(u), i;
  }, []);
  return Yt(e) ? s[0] : s;
...
var bi = Object.assign({}, or, {
    ...
    if (b !== l) {
      ...
      o.setProps(Object.assign({}, h, {
        getReferenceClientRect: typeof h.getReferenceClientRect == "function" ? h.getReferenceClientRect : function() {
          var T;
          return (T = s[p]) == null ? void 0 : T.getBoundingClientRect();
        }
      }));
    }
  }
  ...
  var _ = {
    fn: function() {
      return {
        ...
        onShow: function(p) {
          p.props.showOnCreate && !c && (c = !0, g(p, s[0]));
        },
  ...
  fn: function(t) {
    ...
    if (!((n = t.props.render) != null && n.$$tippy))
      return {};
    var r = jt(t.popper), a = r.box, s = r.content, i = t.props.animateFill ? Oi() : null;
    return {
      onCreate: function() {
  ...
  fn: function(t) {
    ...
    return {
      ...
      onAfterUpdate: function(_, f) {
        ...
        a || x !== void 0 && l.followCursor !== x && (C(), x ? (O(), t.state.isMounted && !s && !u() && d()) : (c(), m()));
      },
      onMount: function() {
        t.props.followCursor && !s && (i && (y(Kt), i = !1), u() || d());
      },
...
var Di = {
  ...
  fn: function(t) {
    ...
    function d(y) {
      return Ei(yr(y), n.getBoundingClientRect(), ot(n.getClientRects()), s);
    }
    function c(y) {
      i = !0, t.setProps(y), i = !1;
    }
    function m() {
      i || c(ki(t.props, u));
    }
...
function Ei(e, t, n, r) {
  ...
  switch (e) {
    case "top":
    case "bottom": {
      var a = n[0], s = n[n.length - 1], i = e === "top", l = a.top, u = s.bottom, d = i ? a.left : s.left, c = i ? a.right : s.right, m = c - d, y = u - l;
      return {
        top: l,
        bottom: u,
        left: d,
...
function _r(e, t = {}, n = { mount: !0, appName: "Tippy" }) {
  ...
  const u = () => l || (l = document.createDocumentFragment(), l), d = (h) => {
    ...
    return jr(M) ? (i.value || (i.value = fn({
      name: n.appName,
      setup: () => () => Ie(h) ? h.value : h
    }), r && Object.assign(i.value._context, r.appContext), i.value.mount(u())), T = () => u()) : typeof M == "object" ? (i.value || (i.value = fn({
      name: n.appName,
      setup: () => () => Ne(Ie(h) ? h.value : h)
    }), r && Object.assign(i.value._context, r.appContext), i.value.mount(u())), T = () => u()) : T = M, T;
  }, c = (h) => {
    let T = {};
    ...
    var h;
    a.value && (a.value.destroy(), a.value = void 0), l = null, (h = i.value) === null || h === void 0 || h.unmount(), i.value = void 0;
  }, _ = () => {
    var h;
    ...
    var h;
    (h = a.value) === null || h === void 0 || h.disable(), s.value.isEnabled = !1;
  }, w = () => {
    var h;
    (h = a.value) === null || h === void 0 || h.enable(), s.value.isEnabled = !0;
  }, o = () => {
    var h;
...
ee({
  ...
  setup(e, { slots: t, emit: n, expose: r }) {
    ...
    e.to && (typeof Element < "u" && e.to instanceof Element ? d = () => e.to : e.to === "parent" ? d = () => {
      let O = a.value;
      return O || (O = a.value = s.value.parentElement), O;
...
const Ni = /* @__PURE__ */ wt(Fi, [["__scopeId", "data-v-3a31d377"]]), Vi = ["id"], qi = { class: "g-gantt-bar-label" }, Xi = ["innerHTML"], Qi = `
  ...
  setup(e) {
    ...
    const t = e, n = Li(), { bar: r } = gt(t), a = (R = t.bar.ganttBarConfig.style) == null ? void 0 : R.backgroundColor, { mapTimeToPosition: s, mapPositionToTime: i } = en(), { font: l, barEnd: u, barStart: d, rowHeight: c, width: m, chartStart: y, chartEnd: O, chartSize: C } = He(), g = U(), { toDayjs: _ } = Jt(), f = U(!1), x = Pe("iconComponent"), w = q(() => r.value.ganttBarConfig), o = Pe(Jn), b = (A) => {
      var N, W;
