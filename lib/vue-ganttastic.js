...
const _a = { class: "g-gantt-legend" }, Ta = { class: "g-gantt-legend-collapse-container" }, Da = { class: "g-gantt-legend-areas-list" }, ka = { class: "g-gantt-legend-promotion" }, Ea = 6, Sa = /* @__PURE__ */ ee({
...
const Aa = /* @__PURE__ */ wt(Sa, [["__scopeId", "data-v-606ee5b9"]]), Ma = { class: "g-gantt-legend" }, Pa = { class: "g-gantt-legend-collapse-container" }, $a = { class: "g-gantt-legend-areas-list" }, Ba = { class: "g-gantt-legend-title" }, La = { class: "g-gantt-legend-area" }, Ra = { class: "g-gantt-legend-category-name" }, Ia = 6, ja = /* @__PURE__ */ ee({
...
function Ot(e) {
  for (var t = we(e), n = xn(e); n && io(n) && ke(n).position === "static"; )
    n = xn(n);
  return n && (De(n) === "html" || De(n) === "body" && ke(n).position === "static") ? t : n || so(e) || t;
}
function rn(e) {
...
function co(e) {
  ...
  if (!(!s || !i)) {
    var m = uo(a.padding, n), b = nn(s), x = u === "y" ? re : ae, O = u === "y" ? pe : ge, v = n.rects.reference[c] + n.rects.reference[u] - i[u] - n.rects.popper[c], C = i[u] - n.rects.reference[u], p = Ot(s), w = p ? u === "y" ? p.clientHeight || 0 : p.clientWidth || 0 : 0, T = v / 2 - C / 2, o = m[x], y = w - b[c] - m[O], g = w / 2 - b[c] / 2 + T, f = ct(o, g, y), _ = u;
...
function On(e) {
  var t, n = e.popper, r = e.popperRect, a = e.placement, s = e.variation, i = e.offsets, l = e.position, u = e.gpuAcceleration, d = e.adaptive, c = e.roundOffsets, m = e.isFixed, b = c === !0 ? vo(i) : typeof c == "function" ? c(i) : i, x = b.x, O = x === void 0 ? 0 : x, v = b.y, C = v === void 0 ? 0 : v, p = i.hasOwnProperty("x"), w = i.hasOwnProperty("y"), T = ae, o = re, y = window;
  if (d) {
...
function ht(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, a = r === void 0 ? e.placement : r, s = n.boundary, i = s === void 0 ? Na : s, l = n.rootBoundary, u = l === void 0 ? nr : l, d = n.elementContext, c = d === void 0 ? ut : d, m = n.altBoundary, b = m === void 0 ? !1 : m, x = n.padding, O = x === void 0 ? 0 : x, v = lr(typeof O != "number" ? O : ur(O, xt)), C = c === ut ? Va : ut, p = e.rects.popper, w = e.elements[b ? C : c], T = Do(tt(w) ? w : w.contextElement || Ye(e.elements.popper), i, u), o = rt(e.elements.reference), y = dr({
    reference: o,
    element: p,
    strategy: "absolute",
    placement: a
...
function So(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var a = n.mainAxis, s = a === void 0 ? !0 : a, i = n.altAxis, l = i === void 0 ? !0 : i, u = n.fallbackPlacements, d = n.padding, c = n.boundary, m = n.rootBoundary, b = n.altBoundary, x = n.flipVariations, O = x === void 0 ? !0 : x, v = n.allowedAutoPlacements, C = t.options.placement, p = _e(C), w = p === C, T = u || (w || !O ? [Rt(C)] : Eo(C)), o = [C].concat(T).reduce(function(ve, oe) {
      return ve.concat(_e(oe) === tn ? ko(t, {
        placement: oe,
        boundary: c,
        rootBoundary: m,
        padding: d,
...
function Ho(e) {
  var t = e.state, n = e.options, r = e.name, a = n.mainAxis, s = a === void 0 ? !0 : a, i = n.altAxis, l = i === void 0 ? !1 : i, u = n.boundary, d = n.rootBoundary, c = n.altBoundary, m = n.padding, b = n.tether, x = b === void 0 ? !0 : b, O = n.tetherOffset, v = O === void 0 ? 0 : O, C = ht(t, {
    ...
    padding: m,
    altBoundary: c
  }), p = _e(t.placement), w = at(t.placement), T = !w, o = rn(p), y = jo(o), g = t.modifiersData.popperOffsets, f = t.rects.reference, _ = t.rects.popper, A = typeof v == "function" ? v(Object.assign({}, t.rects, {
    placement: t.placement
  })) : v, L = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (!!g) {
    ...
    if (l) {
      var it, Ct = o === "x" ? re : ae, _t = o === "x" ? pe : ge, Me = g[y], Re = y === "y" ? "height" : "width", st = Me + C[Ct], Ge = Me - C[_t], lt = [re, ae].indexOf(p) !== -1, Tt = (it = M == null ? void 0 : M[y]) != null ? it : 0, Dt = lt ? st : Me - f[Re] - _[Re] - Tt + L.altAxis, kt = lt ? Me + f[Re] + _[Re] - Tt - L.altAxis : Ge, Et = x && lt ? lo(Dt, Me, kt) : ct(x ? Dt : st, Me, x ? kt : Ge);
      g[y] = Et, k[y] = Et - Me;
    }
    t.modifiersData[r] = k;
  }
...
function Wo(e, t, n) {
  ...
  return (r || !r && !n) && ((De(t) !== "body" || sn(s)) && (l = Uo(t)), fe(t) ? (u = rt(t, !0), u.x += t.clientLeft, u.y += t.clientTop) : s && (u.x = on(s))), {
  ...
  return function(l, u, d) {
    ...
    var c = {
      ...
      setOptions: function(p) {
        ...
        var T = No(qo([].concat(r, c.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!b) {
          ...
          if (!!En(w, T)) {
            c.rects = {
              reference: Wo(w, Ot(T), c.options.strategy === "fixed"),
              popper: nn(T)
...
var mi = 1, Pt = [], Nt = [];
function yi(e, t) {
  var n = Bn(e, Object.assign({}, ye, xr(Mn(t)))), r, a, s, i = !1, l = !1, u = !1, d = !1, c, m, b, x = [], O = Sn(Be, n.interactiveDebounce), v, C = mi++, p = null, w = ti(n.plugins), T = {
    isEnabled: !0,
    isVisible: !1,
    isDestroyed: !1,
    isMounted: !1,
  ...
  function me() {
    M() && (ue("touchstart", Ae, {
      ...
      passive: !0
    })), ei(o.props.trigger).forEach(function(h) {
      if (h !== "manual")
        switch (ue(h, Ae), h) {
          case "mouseenter":
            ue("mouseleave", Le);
  ...
  function Ct() {
    ...
    }), Ue.push.apply(Ue, (D == null ? void 0 : D.modifiers) || []), o.popperInstance = Ko(Ze, g, Object.assign({}, D, {
      placement: P,
      onFirstUpdate: b,
      modifiers: Ue
    }));
...
var bi = Object.assign({}, or, {
  ...
  }, p = E(qe(), Object.assign({}, Jo(n, ["overrides"]), {
...
var ki = {
  ...
  fn: function(t) {
    ...
    function d(b) {
      return Ei(yr(b), n.getBoundingClientRect(), ot(n.getClientRects()), s);
    }
    function c(b) {
...
const Ri = { class: "g-gantt-tooltip-container" }, Ii = { class: "g-gantt-tooltip-area-container" }, ji = { class: "g-gantt-tooltip-area" }, Hi = { class: "g-gantt-tooltip-category-container" }, Yi = { class: "g-gantt-tooltip-category" }, Gi = { class: "g-gantt-tooltip-promotion-title" }, Ui = { class: "g-gantt-tooltip-promotion-time-container" }, zi = { class: "g-gantt-tooltip-time" }, Wi = "cadetblue", Fi = /* @__PURE__ */ ee({
  ...
  setup(e) {
    ...
    const t = Pe("iconComponent"), n = e, { bar: r } = gt(n), a = q(() => {
      ...
      () => {
        var m, b;
        return ((b = (m = r == null ? void 0 : r.value) == null ? void 0 : m.ganttBarConfig.style) == null ? void 0 : b.backgroundColor) || Wi;
      }
    ), l = () => {
      var b, x;
    ...
    return (m, b) => {
      ...
      return S(), R("div", {
        ...
        $("div", Ri, [
          $("div", Ii, [
            $("span", ji, te((v = (O = (x = B(r)) == null ? void 0 : x.ganttBarConfig) == null ? void 0 : O.tooltipInfo) == null ? void 0 : v.areaName), 1),
            B(r) ? (S(), J(je(B(t)), {
              key: 0,
          ...
          $("div", Hi, [
            ...
            $("span", Yi, te((y = (o = (T = B(r)) == null ? void 0 : T.ganttBarConfig) == null ? void 0 : o.tooltipInfo) == null ? void 0 : y.categoryName), 1),
            $("div", {
              class: "g-gantt-tooltip-color-line g-gantt-tooltip-color-line-right",
              style: F({ background: i.value })
            }, null, 4)
          ]),
          $("p", Gi, te((_ = (f = (g = B(r)) == null ? void 0 : g.ganttBarConfig) == null ? void 0 : f.tooltipInfo) == null ? void 0 : _.title), 1),
          $("div", Ui, [
            $("p", zi, [
              Z(m.$slots, "default", {
                bar: B(r),
...
const Ni = /* @__PURE__ */ wt(Fi, [["__scopeId", "data-v-3a31d377"]]), Vi = ["id"], qi = { class: "g-gantt-bar-label" }, Xi = ["innerHTML"], Qi = `
  ...
  setup(e) {
    ...
    const t = e, n = Li(), { bar: r } = gt(t), a = (L = t.bar.ganttBarConfig.style) == null ? void 0 : L.backgroundColor, { mapTimeToPosition: s, mapPositionToTime: i } = en(), { font: l, barEnd: u, barStart: d, rowHeight: c, width: m, chartStart: b, chartEnd: x, chartSize: O } = He(), v = U(), { toDayjs: C } = Jt(), p = U(!1), w = Pe("iconComponent"), T = q(() => r.value.ganttBarConfig), o = Pe(Jn), y = (M) => {
      var N, W;
    ...
    Te(() => {
      !(v != null && v.value) || _r(v.value, {
        content: Ne(Ni, { bar: r.value, config: { barStart: d, barEnd: u, font: l }, toDayjs: C }),
        arrow: Qi,
        interactiveBorder: 0,
        placement: "top",
        interactive: !0,
