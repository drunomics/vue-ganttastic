<template>
  <div
    class="g-gantt-legend"
  >
    <g-gantt-legend-non-collapsed-view v-if="!isCollapsed" v-model:is-collapsed="isCollapsed" :arrow-name="arrowName" :legend="legend" />
    <g-gantt-legend-collapsed-view v-else v-model:is-collapsed="isCollapsed" :arrow-name="arrowName" :legend="legend" />
  </div>
</template>
